...
wiederhergestellt. Die nächste fachliche Arbeit ist Issue #25; sie beginnt erst
nach Abschluss dieses Post-Merge-Statussyncs mit eigenem Plan-first-Workflow.
`ISSUE25_STARTED=NO` und `ACTUATOR_RELEASE=NO` bleiben bis dahin verbindlich.
