...
`PROBE_FAIL_CLOSED_GT_60S=NOT_VERIFIED`; `ACTUATOR_RELEASE=NO`. Die revidierte Host-Clang-21-Planfassung steht unter `HOST_CLANG21_REVISED_PLAN_SHA=9b945e535dcdc95a90cffcbd08990ab948b2f96a` und wartet auf Owner-Freigabe. Die vollständige Baseline-Evidence liegt unter `docs/audits/ISSUE_31_HOST_CLANG21_UNCHANGED_BASELINE_RAW.txt`; die Umsetzung bleibt bis zur Freigabe und separaten Klärung der Correctness-/Wartbarkeitsbefunde gestoppt.
