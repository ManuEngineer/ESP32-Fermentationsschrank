...
|---:|---|---|---|
| 0 | Issue #152 – owning Vertrag manueller Zeit-/Temperaturlauf | `ISSUE152_STATUS=IMPLEMENTATION_DRAFT`; `PR153=OPEN/DRAFT`; `PR153_HEAD=b77e8271d4a9865199b02eb2016cb60049682253`; `EVIDENCE_COMMIT=739f5526e8f9d91db79957be8077fd7b3cec31ed`; `PLAN_COMMIT=292a8096b981c2137545bb88961f92b9b7a52139`; `PLAN_APPROVED=YES`; `PLAN_FIRST=YES`; `BASE_SHA=0b8b4cc1673f40296a510fdc0d79440c616ffeb8`; `IMPLEMENTATION=COMPLETED_PENDING_FIX_VERIFICATION`; `NATIVE_TESTS=PASS_TARGETED_283_OF_283`; `DOWNSTREAM_ISSUE=26`; `ACTUATOR_RELEASE=NO` | Enge Fix Verification der zwei Evidence-Blocker auf dem exakten finalen HEAD; danach Owner-Gates |
...
`PR153_HEAD=6bddef1ecbb9623ca2de44ed57b3c6913f995fe7`,
