...
| 4 | Issue #121 – Release-1 Device-/Application-Lifecycle- und Safety-Policy-Vereinfachung | `IMPLEMENTATION_STEP_8=PRE_HARDWARE_STATIC_GATES_PASS`; freigegebener Plan `docs/tasks/issue-121-lifecycle-safety-simplification-plan.md @ 1568c8930aeb759468aeca1e27da93889875554a`; Schritte 1–7 PASS und ownerreviewt; `STEP_8_STACK_CORRECTION_SOURCE_SHA=576c10463540ca9b93d8b852089d4ce9f4a13d08`; `STEP_8_STATIC_ANALYSIS_SOURCE_SHA=6e3c722e36b28e00e9e7ffc84e44fdc8289a5f4f`; reale Release-/Bring-up-Produkt-Callgraph-Evidenz zeigt `PRODUCT_BOOT_CUMULATIVE_STACK_PATH=1888 B` (Headroom `1696 B`) und `PRODUCT_DISCARD_CUMULATIVE_STACK_PATH=2368 B` (Headroom `1216 B`) bei `CONFIGURED_RELEASE_MAIN_TASK_STACK=3584 B`; `PRODUCT_REACHABLE_STATIC_STACK_GATE=PASS`; alle erforderlichen Frames sind statisch und die relevanten kompilierten Callgraph-Kanten vorhanden; kein produktiv erreichbarer Einzel-Frame ueberschreitet das Taskbudget. `ESP_IDF_BRINGUP_BUILD=PASS`, `ESP_IDF_RELEASE_BUILD=PASS`, `ESP_CLANG_BRINGUP=PASS`, `ESP_CLANG_RELEASE=PASS`, `ESP_IDF_NVS_ADAPTER_HOST=PASS`, `ARCHITECTURE_BOUNDARIES=PASS`, `SECRET_SCAN=PASS` und `GIT_DIFF_CHECK=PASS`; `PRODUCT_FRESH_START_CUMULATIVE_STACK_PATH=NOT_PRODUCT_REACHABLE`; `PRODUCT_RESUME_CUMULATIVE_STACK_PATH=NOT_PRODUCT_REACHABLE`; `STATIC_DRAM_DELTA=0 B`; `OWNER_HARDWARE_RUN_AUTHORIZATION=REQUIRED`; `MAIN_TASK_STACK_HIGH_WATERMARK=NOT_RUN`; `HEAP_LARGEST_BLOCK_RUNTIME_GATE=NOT_RUN`; `HARDWARE_RUN=NO`; `PR120=OPEN_DRAFT_FROZEN`; `PR122=OPEN_DRAFT`; `ISSUE121=OPEN`; `MERGE=NO`; `PLAN_CHANGE=NO`; `TASK_STACK_SIZE_INCREASE=NO`; `WIRE_FORMAT_CHANGE=NO`; `SCHEMA_CHANGE=NO`; `PLAN_DEVIATION=NONE`; `SOURCE_OF_TRUTH_CONFLICT=NONE`. | STOP – Owner-Review der Schritt-8A-Pre-Hardware-Gates; keine Hardwarefreigabe, kein Main-Task-HWM, keine Runtime-Heap-/Largest-Block-Messung und kein Merge durch den Agenten. |
