...
| 2 | Issue #24 – Fehlerklassen, Verriegelung, SAFE_BOOT und Fehlerinjektion | PR #110 ist Draft; der Owner Scope Reset vom 2026-08-17 hat die vorherigen Planstände als superseded/not approved abgelöst; die neue vollständige Planrevision `docs/tasks/issue-24-safety-core-replan.md` ist mit `0776fb0bcb9738b3d6d92056569b26b4d6824517` committed und schließt F1–F8 einschließlich der kanonischen F5-Einzel-Write-/F7-Gesamttransaktionssemantik, der minimalen F8-Fault-Code-Lifecycle-Matrix und der Live-Issue-Synchronisierung; Implementation NOT_STARTED | Owner-Review der exakten Plan-SHA `0776fb0bcb9738b3d6d92056569b26b4d6824517` |
