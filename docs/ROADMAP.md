...
| 2 | Issue #90 – produktiver ESP-IDF-NVS-Adapter fuer `IStateStore` | `R5_9_PLAN_APPROVED_AWAITING_SLICE_1_OWNER_GATE`; R5.9 ist auf dem korrigierten PR-#116-Head `25b41ae75ef8de04576623411f068876427a87cd` ownerfreigegeben. R5.8 `3766e96d2e4091e26e0a33de9ed094850f0f28f7` bleibt historische, nicht ownerfreigegebene Revision; PR #117 bleibt historische OPEN/Draft-Umsetzung. Keine zweite Persistenzarchitektur. #29-Priorisierung ist kein pauschaler Blocker für #90-Software-/Hostarbeit; reale #90-Boardtests bleiben actor-free. | Separate ausdrückliche Ownerfreigabe für Slice 1 auf Basis der ownerfreigegebenen R5.9-Plan-SHA `baf0b2ae04cd42afa75dfa00e21d900116b38bc8`; danach separat gegatete Recovery-Orakel-, Backend-zu-Produkt-Recovery-, Bestands-, Minimalfix-, NVS-, Software- und actor-free Board-Slices |
