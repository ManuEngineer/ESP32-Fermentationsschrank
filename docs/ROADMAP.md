...
|---:|---|---|---|
| 0 | Issue #159 – ESP-IDF 6.0.2 auf 6.1 aktualisieren | `ISSUE159=OPEN`; `PR160=MERGED`; `PR160_MERGE_COMMIT=dc017f4ee7c4f33be240fac23c1686606f340225`; `PLAN_FIRST=YES`; `PLAN_APPROVAL=APPROVED`; `APPROVED_PLAN_SHA=b7747dc270a513f5dea45bb86f274a85ae2bf1cf`; `INDEPENDENT_REVIEW=PASS`; `REVIEWED_HEAD=41546b6f4e24a46b32ead1b01d26093b36759d1a`; `OPEN_BLOCKERS=0`; `IMPLEMENTATION=BUILDER_COMPLETE`; `TARGETED_CHECKS=PASS`; `BUILDER_STATIC_ANALYSIS_SELF_CHECK=PASS`; `FIX_VERIFICATION_HEAD=fc306c4428a2bd770866e5f23ce0881f38bc1baf`; `HOST_PRE_READY=PASS`; `FULL_PROFILE_BUILDS=PASS`; `FULL_ESP_CLANG=PASS`; `SDKCONFIG_RESOURCE_WARNING_COMPARISON=PASS`; `HARDWARE_SMOKE_BRINGUP=PASS`; `HARDWARE_SMOKE_RELEASE=PASS`; `SMOKE_HEAP_STACK_VALUES=DOCUMENTED`; `STACK_HEAP_LOAD_MEASUREMENT=NOT_RUN`; `ISSUE90_POWER_CUT_RESTORE=OWNER_WAIVED`; `HARDWARE_PARITY=PASS_WITH_OWNER_WAIVER`; `TARGET=v6.1@fff9895c82d744c7237be8847347bdd1b07c6643`; `ACTUATOR_RELEASE=NO`; PR #158 bleibt unveraendert ausserhalb des Scopes. | Owner-Entscheidung ueber Issue-#159-Abschluss (PR gemergt, Issue bleibt offen bis Owner schliesst) |
...
- Kein Issue (Owner-Entscheidung: ohne Issue-Referenz) / PR #161 – GitHub-CI ESP-IDF-Setup beschleunigen als parallele CI-/Governance-Arbeit: `PLAN_FIRST=YES`; `APPROVED_PLAN_SHA=e354b2026a5a73450a96be661a9e4b87f1a5e027`; `CACHING_VS_DOCKER=OWNER_APPROVED_CACHING`; `IMPLEMENTATION=IN_PROGRESS`; `INDEPENDENT_REVIEW=IN_PROGRESS_CORRECTION_CYCLE`; `OPEN_BLOCKERS=UNKNOWN_PENDING_REVIEW`; `GITHUB_CI=NOT_RUN_DRAFT`; `ACTUATOR_RELEASE=NO`.
