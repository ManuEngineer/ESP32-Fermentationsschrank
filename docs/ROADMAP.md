...
|---:|---|---|---|
| 1 | Issue #29 – ESP32-Bring-up, Partition, Ressourcen und sichere Ausgangszustaende | `ISSUE29=OPEN`; `CURRENT_DEVELOPMENT_BASE=integration/r1-development @ c1f5fbb5f19ab8e7d2c25708fe79777d523217d4`; `OWNER_PLAN_REVIEW=PASS`; `APPROVED_PLAN_SHA=4a34967ac202196b7afceaebfe2b2429338d6d93`; `IMPLEMENTATION=IN_PROGRESS`; `ISSUE29_DIAGNOSTIC_TASK_STATIC_STACK_GATE=BLOCKED` (real, reproduzierbar: 32 eindeutige unaufgeloeste externe Randstellen, u. a. `operator new` objdump-bestaetigt nicht-leaf); `PLAN_CHANGE_REQUIRED=YES` (Plan 4.2 benennt nur `heap`; realer Umfang ist groesser, ein Teil toolchain-vorkompiliert und ohne Quellcode strukturell nicht schliessbar); `ROOT_CAUSE=UNRESOLVED`; `HARDWARE_REQUALIFICATION=PENDING_OWNER_REVIEW`; `LEVEL_GATE=DEFERRED_PENDING_STABLE_REQUALIFICATION`; `CODE_CHANGE=YES` (nur Analyzer-Skript + Analysis-only-Instrumentierung in `lib/device_platform`/`main` CMake, keine Produkt-/Safety-Logik, kein Hardwarelauf). Details: Issue #29, `docs/ISSUE_29_MEASUREMENTS.md`, `docs/ISSUE_29_BUILD_REPORT.md`, `docs/tasks/issue-29-panic-requalification-correction-plan.md @ 4a34967ac202196b7afceaebfe2b2429338d6d93`. | Owner-Entscheidung zur Scope-Erweiterung von Plan 4.2 (weitere ESP-IDF-Components) und zur strukturell nicht schliessbaren toolchain-vorkompilierten Randmenge; erst danach weitere Digital-Gate-Arbeit, danach erneute 3/3-Hardware-Requalifikation, erst danach Pegelmessung. #29 bleibt von der #90-Power-Cut-Kampagne getrennt; #25 bleibt bis zur Owner-finalen #29-Entscheidung blockiert. |
