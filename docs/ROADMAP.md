...
|---:|---|---|---|
| 0 | Issue #89 – WLAN-Onboarding und Provisionierung evaluieren | `ISSUE89_STATUS=EVALUATION_COMPLETE`; `PR=158`; `PR_HEAD=2f5c7b144fa35933b58595550de7aee63bed559e`; `BASE_SHA=7029df3997bb92e60379eb218f1894f86c5f7d55`; `APPROVED_PLAN_SHA=74474268391b47718aa3c751d16a0d5e815efc5c`; `PLAN_STATUS=APPROVED`; `PHASE_A_6_1_REVALIDATION=PASS`; `PHASE_B_FLASH_BOOT_EVIDENCE=PASS`; `ANDROID_CLIENT_EVIDENCE=PASS`; `ANDROID_CAPTIVE_PORTAL_AUTO_OPEN=NOT_REPORTED`; `IOS_CLIENT_EVIDENCE=WAIVED_BY_OWNER`; `WINDOWS_CLIENT_EVIDENCE=WAIVED_BY_OWNER`; `PHYSICAL_DISPLAY_QR_TEST=DEFERRED_NOT_BLOCKING_ISSUE89_SELECTION`; `POWER_CUT_TESTS=WAIVED_BY_OWNER`; `PHASE_B_COMPARABLE_CLIENT_EVIDENCE=PASS_MINIMAL_PROPORTIONAL`; `CANDIDATE_SELECTION=NATIVE_ESP_IDF_HTTP`; `OWNER_CANDIDATE_SELECTION=COMPLETED`; `OWNER_CANDIDATE_SELECTION_GATE=COMPLETED`; `HTTP_SCOPE_DECISION=B`; `ISSUE164_SHARED_HTTP_FOUNDATION=YES`; `ISSUE27_NORMAL_WEB_UI_OWNERSHIP=PRESERVED`; `SECOND_HTTP_SERVER=NO`; `AP_ONLY_STATE_LOGIC=CORRECTED`; `DISPLAY_CONTRACT_SPLIT_ISSUE164_ISSUE31=CORRECTED`; `R1_NETWORK_SCOPE_SYNC=PASS`; `EVIDENCE=docs/audits/ISSUE_89_WLAN_ONBOARDING_EVIDENCE.md`; `FUTURE_SCOPE_DOC=docs/FUTURE_SCOPE.md`; `FUTURE_SCOPE_ISSUE=163`; `R1_IMPLEMENTATION_ISSUE=164`; `INTEGRATION_PLAN_PATH=docs/tasks/issue-164-r1-wlan-native-http-integration-plan.md`; `INTEGRATION_PLAN_SHA=524dbaaf34f2350f407872640124a356155e4a1d`; `INTEGRATION_PLAN_STATUS=OWNER_APPROVAL_REQUIRED`; `PRODUCTIVE_CONNECTIVITY_PERSISTENCE=NOT_STARTED`; `PRODUCTIVE_IMPLEMENTATION=NOT_STARTED`; `ACTUATOR_RELEASE=NO`; `IMPLEMENTATION=SPIKE_ONLY_EVIDENCE`. Die drei Kandidaten wurden mit Android/Linux-Host proportional bewertet; der Owner hat den nativen ESP-IDF-HTTP-Pfad als R1-Kandidaten gewaehlt. Issue #89 bleibt die Evaluation; #164 ist die separate, noch nicht autorisierte Integration. | Unabhaengige Planpruefung und Ownerfreigabe von `INTEGRATION_PLAN_SHA=524dbaaf34f2350f407872640124a356155e4a1d`; keine produktive WLAN-Integration |
