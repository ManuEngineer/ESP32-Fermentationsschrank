...
| 4 | Issue #121 – Release-1 Device-/Application-Lifecycle- und Safety-Policy-Vereinfachung | `IMPLEMENTATION=IN_PROGRESS_BLOCKED_BEFORE_STEP_6`; Schritte 1–5 ownerreviewt PASS, `STEP_5_EFFECTIVE_SOURCE_SHA=7049380d0e4bd9c0522c4475fa156febcd63ed5d`. Kanonischer R1-Plan `docs/tasks/issue-121-lifecycle-safety-simplification-plan.md @ 86009eeba99b260a056c22ec82fd6c66c9531c73`; `PRIOR_APPROVED_PLAN_SHA=e249b51cedf6f6a3edbce3a0889c48d77b79e828`, `PRIOR_REVIEWED_CORRECTION_SHA=9b101295af6468878057758356de33848ec18061`, `PLAN_CORRECTION_REASON=BOOT_CLASSIFICATION_AND_CONFIGURATION_TRUST_MUST_REMAIN_SEPARATE`, `OWNER_PLAN_REVIEW=PENDING`. Architektur und historische Korrektur bleiben unverändert: `FERMENTATION_APP_DEPENDS_ON_DEVICE_PLATFORM_ESP_IDF=NO`, frühere Korrektur `FERMENTATION_APP_MUST_NOT_DEPEND_ON_DEVICE_PLATFORM_ESP_IDF` ist Historie, Resolver-Owner ist die ESP-IDF-Composition-Root, Native-Smoke-Overload bleibt erhalten. `IMPLEMENTATION_STEP_6=NOT_STARTED`, `STEP_6_SOURCE_SHA=NOT_CREATED`, `IMPLEMENTATION_STEP_7=NOT_STARTED`, `PR120=OPEN_DRAFT_FROZEN`, `PLAN_INTERNAL_CONFLICT=NONE`, `SOURCE_OF_TRUTH_CONFLICT=NONE`, `PRODUCTION_CODE_CHANGE=NO`, `TEST_CODE_CHANGE=NO`, `HARDWARE_RUN=NO`. | STOP – Owner Full Review der neuen exakten Plan-SHA `86009eeba99b260a056c22ec82fd6c66c9531c73`; keine Implementation beginnen. |
