...
| 6a | Issue #130 – R1-GPIO-SSOT und Synchronisierung der Hardware-Issues | `ISSUE130=OPEN`; `PR131=OPEN_DRAFT`; `PLAN_REEVALUATION=COMPLETE`; `GPIO_SSOT=PLANNED`; `ISSUE_SYNC=PLANNED`; `OLD_ISSUE_PIN_ASSUMPTIONS=NON_AUTHORITATIVE`; `EXTERNAL_RESISTORS=OWNER_APPROVED_AS_SPECIFIED`; `IMPLEMENTATION=NOT_STARTED`; `GPIO_MATRIX=PLANNED_NOT_CONFIRMED`; `HARDWARE_RUN=NOT_RUN`; `OWNER_PLAN_REVIEW_REQUIRED=YES`; Plan: `docs/tasks/issue-130-r1-gpio-matrix-plan.md @ PENDING_OWNER_REVIEW`; #29/PR129 sowie #30/#31/#32/#33 bleiben getrennte Hardware-/Verifikationsgates. | Exakte neue Plan-SHA durch Owner freigeben; danach Boardprofil, kanonische Hardware-/YAML-Dokumente und relevante Issue-Verweise gemäß Plan synchronisieren. Keine Matrix-Implementierung, keine Aktorfreigabe und kein `confirmed_test` durch diesen PR vor der Freigabe. |
