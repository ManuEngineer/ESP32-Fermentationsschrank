...
| 4 | Issue #121 – Release-1 Device-/Application-Lifecycle- und Safety-Policy-Vereinfachung | `IMPLEMENTATION=STEP_6_PASS_OWNER_REVIEW_PENDING`; Schritte 1–5 ownerreviewt PASS, `STEP_5_EFFECTIVE_SOURCE_SHA=7049380d0e4bd9c0522c4475fa156febcd63ed5d`. Kanonischer R1-Plan `docs/tasks/issue-121-lifecycle-safety-simplification-plan.md @ 86009eeba99b260a056c22ec82fd6c66c9531c73`; `PRIOR_APPROVED_PLAN_SHA=e249b51cedf6f6a3edbce3a0889c48d77b79e828`, `PRIOR_REVIEWED_CORRECTION_SHA=9b101295af6468878057758356de33848ec18061`, `PLAN_CORRECTION_REASON=BOOT_CLASSIFICATION_AND_CONFIGURATION_TRUST_MUST_REMAIN_SEPARATE`, `OWNER_PLAN_REVIEW=PASS`. Architektur und historische Korrektur bleiben unverändert: `FERMENTATION_APP_DEPENDS_ON_DEVICE_PLATFORM_ESP_IDF=NO`, frühere Korrektur `FERMENTATION_APP_MUST_NOT_DEPEND_ON_DEVICE_PLATFORM_ESP_IDF` ist Historie, Resolver-Owner ist die ESP-IDF-Composition-Root, Native-Smoke-Overload bleibt erhalten. `IMPLEMENTATION_STEP_6=PASS`, `STEP_6_SOURCE_SHA=d764de7d83ab5bb73d50500e03c99df00fc8bba2`, `IMPLEMENTATION_STEP_7=NOT_STARTED`, `PRODUCT_REACHABLE_STATIC_STACK_GATE=NOT_FINAL_STEP_6`, `PR120=OPEN_DRAFT_FROZEN`, `PLAN_INTERNAL_CONFLICT=NONE`, `SOURCE_OF_TRUTH_CONFLICT=NONE`, `PRODUCTION_CODE_CHANGE=PASS`, `TEST_CODE_CHANGE=PASS`, `HARDWARE_RUN=NO`. | Schritt 6 technisch umgesetzt; gezielte native/ESP-IDF-Software-, Build-, Static-Analysis- und Architektur-Gates PASS. STOP – Owner Review von Schritt 6; Schritt 7 und Hardware nicht beginnen. |
