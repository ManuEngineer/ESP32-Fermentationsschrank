...
|---:|---|---|---|
| 0 | Issue #159 – ESP-IDF 6.0.2 auf 6.1 aktualisieren | `ISSUE159=OPEN`; `PR160=DRAFT`; `PLAN_FIRST=YES`; `PLAN_APPROVAL=APPROVED`; `APPROVED_PLAN_SHA=8b181954949fe32d32a26312f8eefe415f65acd1`; `INDEPENDENT_REVIEW=PASS`; `REVIEWED_HEAD=41546b6f4e24a46b32ead1b01d26093b36759d1a`; `OPEN_BLOCKERS=0`; `IMPLEMENTATION=BUILDER_COMPLETE`; `TARGETED_CHECKS=PASS`; `BUILDER_STATIC_ANALYSIS_SELF_CHECK=PASS`; `FIX_VERIFICATION_HEAD=fc306c4428a2bd770866e5f23ce0881f38bc1baf`; `HOST_PRE_READY=PASS`; `FULL_PROFILE_BUILDS=PASS`; `FULL_ESP_CLANG=PASS`; `SDKCONFIG_RESOURCE_WARNING_COMPARISON=PASS`; `STACK_HEAP=NOT_RUN`; `HARDWARE_PARITY=BLOCKED_HARDWARE`; `TARGET=v6.1@fff9895c82d744c7237be8847347bdd1b07c6643`; `ACTUATOR_RELEASE=NO`; PR #158 bleibt unveraendert ausserhalb des Scopes. | Hardware-Paritaetsnachweis auf der bereits v6.0.2-qualifizierten Oberflaeche; danach Owner-Ready-/CI-/Merge-Gates gemaess bestehendem Upgradevertrag |
