...
|---:|---|---|---|
| 1 | Draft-PR #102 / Issue #18 – Wiederanlauf und temperaturgewichteter Fortschritt | Planung laeuft auf Basis von `main` (`17ab3f5`, inkl. PR #103); Revision 11 in Arbeit, Freigabe steht aus | Owner prueft und gibt exakten Plan-Commit frei |
