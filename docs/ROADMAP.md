...
|---:|---|---|---|
| 0 | Issue #89 – WLAN-Onboarding und Provisionierung evaluieren | `PLAN_FIRST=YES`; `PLAN_REVISION=OWNER_APPROVAL_REQUIRED`; `BASE_SHA=7029df3997bb92e60379eb218f1894f86c5f7d55`; `CURRENT_PLAN_SHA=5c582aa179cd6e382dc4442a6824bb79a1e2b22f`; `HISTORICAL_PLAN_SHA=d8d506da1d5bde129c09d623263d7657c38f28a3`; `HISTORICAL_PHASE_A_6_0_2_EVIDENCE=PASS`; `PHASE_A_6_1_REVALIDATION=PENDING`; `PHASE_B_COMPARABLE_CLIENT_EVIDENCE=PENDING`; `OWNER_CANDIDATE_SELECTION_GATE=NOT_READY`; `IMPLEMENTATION=EVIDENCE_ONLY`; `EVIDENCE=docs/audits/ISSUE_89_WLAN_ONBOARDING_EVIDENCE.md`; `CANDIDATE_SELECTION=OWNER_PENDING_AFTER_COMPARABLE_EVIDENCE`; `PRODUCTIVE_CONNECTIVITY_PERSISTENCE=NOT_STARTED`; `ACTUATOR_RELEASE=NO`. Keine neue Sensor-, Display- oder Aktorverkabelung fuer Host-/actor-free Evidence; reale Client-/QR-Nachweise separat. | 6.1-Evidence nach Freigabe der neuen exakten Plan-SHA gezielt ausfuehren; danach vergleichbare Browser-/Client-/Recovery-/Ressourcenmatrix, Owner-Gate fuer Browser-only und Kandidat; keine produktive Integration vorher |
