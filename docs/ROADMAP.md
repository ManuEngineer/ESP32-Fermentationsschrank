...
|---:|---|---|---|
| 0 | Issue #164 – R1-WLAN-Integration ueber nativen ESP-IDF-HTTP-Pfad | `PLAN_FIRST=YES`; `BASE_SHA=7029df3997bb92e60379eb218f1894f86c5f7d55`; `APPROVED_PLAN_SHA=524dbaaf34f2350f407872640124a356155e4a1d`; `OWNER_PLAN_APPROVAL=CONFIRMED_BY_OWNER`; `IMPLEMENTATION=IN_PROGRESS`; `PR=165_DRAFT`; `PRODUCTIVE_CONNECTIVITY_PERSISTENCE=NOT_STARTED`; `ACTUATOR_RELEASE=NO`. | Vertragsrevalidierung, Port-/Preview-Schicht, ESP-IDF-Adapter, gemeinsamer HTTP-Lifecycle und #164-Setup-Routen gemaess freigegebenem Plan; danach Builder-Self-Check und Independent Full Review |
| 1 | Issue #89 – WLAN-Onboarding und Provisionierung evaluieren | `PLAN_FIRST=YES`; `PLAN_REVISION=ESP_IDF_6_1_PHASE_B_PROPORTIONAL_OWNER_GATE`; `BASE_SHA=7029df3997bb92e60379eb218f1894f86c5f7d55`; `CURRENT_PLAN_SHA=74474268391b47718aa3c751d16a0d5e815efc5c`; `APPROVED_PLAN_SHA=74474268391b47718aa3c751d16a0d5e815efc5c`; `OWNER_PLAN_APPROVAL=CONFIRMED_BY_OWNER`; `PLAN_STATUS=APPROVED`; `PHASE_A_6_1_REVALIDATION=PASS`; `PHASE_B_FLASH_BOOT_EVIDENCE=PASS`; `ANDROID_CLIENT_EVIDENCE=PASS`; `IOS_CLIENT_EVIDENCE=WAIVED_BY_OWNER`; `WINDOWS_CLIENT_EVIDENCE=WAIVED_BY_OWNER`; `PHYSICAL_DISPLAY_QR_TEST=DEFERRED_NOT_BLOCKING_ISSUE89_SELECTION`; `POWER_CUT_TESTS=WAIVED_BY_OWNER`; `PHASE_B_COMPARABLE_CLIENT_EVIDENCE=PASS_MINIMAL_PROPORTIONAL`; `CANDIDATE_SELECTION=NATIVE_ESP_IDF_HTTP`; `OWNER_CANDIDATE_SELECTION=COMPLETED`; `OWNER_CANDIDATE_SELECTION_GATE=COMPLETED`; `R1_NETWORK_SCOPE_SYNC=PASS`; `EVIDENCE=docs/audits/ISSUE_89_WLAN_ONBOARDING_EVIDENCE.md`; `FUTURE_SCOPE_DOC=docs/FUTURE_SCOPE.md`; `FUTURE_SCOPE_ISSUE=163`; `R1_IMPLEMENTATION_ISSUE=164`; `INTEGRATION_PLAN_PATH=docs/tasks/issue-164-r1-wlan-native-http-integration-plan.md`; `INTEGRATION_PLAN_SHA=524dbaaf34f2350f407872640124a356155e4a1d`; `PRODUCTIVE_CONNECTIVITY_PERSISTENCE=NOT_STARTED`; `PRODUCTIVE_IMPLEMENTATION=SEPARATELY_IN_PROGRESS`; `ACTUATOR_RELEASE=NO`; `IMPLEMENTATION=SPIKE_ONLY_EVIDENCE`. Die drei Kandidaten wurden mit Android/Linux-Host proportional bewertet; der Owner hat den nativen ESP-IDF-HTTP-Pfad als R1-Kandidaten gewaehlt. Issue #89 bleibt die abgeschlossene Evaluation; die produktive Integration laeuft separat in #164. | Keine weitere Kandidatenauswahl; #164 ist der separate produktive Integrationsscope |
