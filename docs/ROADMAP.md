...
|---:|---|---|---|
| 1 | Draft-PR #105 (Branch `agent/issue-23-aktorplaner-plan`) / Issue #23 – Aktorplaner, Mindestzeiten, Totzeit und Luefterlogik | Planrevision 8 (`docs/tasks/issue-23-actuator-planner-plan.md`, Commit `3fa28d32ce9a0782edb984f27006467eb8d5f532`) ist ownerfreigegeben; Owner-Review nach Item 4-7 ergab Befunde F1-F8, Plan-Item 8 bleibt gesperrt. F1-F4 (Feedback-Episoden-Subjekt, Sink-Driver-Fail-closed, Aussenluefter-Zwang, plannerlose evaluateTemperatureControl()) sowie F6/F7 (Multi-Rate-Integrator-Orakel) sind auf HEAD `7d30a86` behoben und mit dedizierten Regressionstests belegt; F5 liegt als Coverage-Matrix im SESSION-HANDOVER-Kommentar vor mit offenen GAP-Zeilen; F8 (vollstaendige Cross-Sink-Trace-Auswertung) ist nicht begonnen; `test_actuator_planner` 26/26, Sink-Driver 6/6, Application-/Persistenzpfad 110/110 und `test_temperature_control` 40/40 PASS; Architektur-/Secret-Gates PASS; vollstaendiger Native-Lauf, ESP-IDF, Build-/Hardware-/CI- und Owner-Gesamtlauf NOT_RUN; Item 8 sowie produktive #106-Verdrahtung bleiben offen; Issue #106 bleibt unveraendert offen und separates produktives Integrationsgate; Base `main @ 2986dca5736a34171910c9245a3d5f43fa55da06` (Merge von PR #104 / Issue #22) | Owner-Review der F1-F8-Korrekturen und der F5-Coverage-Matrix fuer Draft-PR #105 |
