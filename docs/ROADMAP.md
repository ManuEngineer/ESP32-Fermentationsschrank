...
| 4 | Issue #121 – Release-1 Device-/Application-Lifecycle- und Safety-Policy-Vereinfachung | `IMPLEMENTATION=STEP_7_IMPLEMENTED_PENDING_OWNER_REVIEW`; `OWNER_PLAN_REVIEW=PASS`; `APPROVED_PLAN_SHA=68b81a16892a3a27c2eabdb8f571e34f1c107bbb`; `IMPLEMENTATION_STEP_6=PASS`; `OWNER_STEP_6_REVIEW=PASS`; `STEP_6_EFFECTIVE_SOURCE_SHA=5d8bc4d55d996c282fddd05a30ffde7184a12238`; `IMPLEMENTATION_STEP_7=PASS`; `STEP_7_SOURCE_SHA=4270c5eaa06e607a943e572ddc6d0f5f65900dc8`; `OWNER_STEP_7_REVIEW=REQUIRED`; `IMPLEMENTATION_STEP_8=NOT_STARTED`; `PRODUCT_REACHABLE_STATIC_STACK_GATE=NOT_RUN_STEP_7`; `TEST_CODE_CHANGE=YES`; `PRODUCTION_CODE_CHANGE=NO`; `PLAN_CODE_CHANGE=NO`; `ARCHITECTURE_CHECKER_CHANGE=NO`; `WIRE_FORMAT_CHANGE=NO`; `SCHEMA_MIGRATION_REQUIRED=NO`; `PLAN_DEVIATION=NONE`; `HARDWARE_RUN=NO`; `PR120=OPEN_DRAFT_FROZEN`; `PR122=OPEN_DRAFT`; `ISSUE121=OPEN`; `MERGE=NO`; `SOURCE_OF_TRUTH_CONFLICT=NONE`. Schritt 7 ergänzt ausschließlich fehlende Regressionen in vier Testdateien. Alle relevanten nativen Suiten: `488/488 PASS`; `esp_idf_nvs_adapter_host=PASS`; `esp32_bringup=PASS`, `esp32_release=PASS`; clang-format, Architekturgrenzen, Secret-Scan und `git diff --check` PASS. Kein finales Produkt-Stackgate, kein Hardwarelauf und keine GitHub-Firmware-CI. | STOP – Owner Review von Umsetzungsschritt 7 auf `STEP_7_SOURCE_SHA`; Schritt 8, finales Produkt-Stackgate, Hardwarelauf und Merge bleiben ausgeschlossen. |
