...
| 6 | Issue #126 – R1-Absolute-Zeitplattform mit DS3231 und ESP-IDF-SNTP | `PLAN_ONLY`; `IMPLEMENTATION=NOT_STARTED`; `MERGE=NO`; `OWNER_PLAN_REVIEW_REQUIRED=YES`; `OWNER_DECISIONS_REQUIRED=NONE`; `RTC_HARDWARE_OPTIONAL=YES`; `NTP_ONLY_MODE_SUPPORTED=YES`; `NEW_PRODUCTIVE_RUN_START_REQUIRES_TRUSTED_UTC=YES`; `I2C_PORT_LIFETIME_OWNER=I2CDEV_IF_ADOPTED`; `RTC_HARDWARE=BLOCKED_OWNER_HARDWARE_PENDING`; `NTP_REAL_NETWORK_RUN=NOT_RUN`; kanonischer Plan: `docs/tasks/issue-126-absolute-time-rtc-ntp-plan.md @ 883c00f3108d29fd2e7096c33102a942557ec3ab`; #89 bleibt Connectivity-Eigentümer, #124 bleibt fachlich unverändert. | Owner-Review des exakten Plan-Commits; danach nur mit Freigabe umsetzen. |
