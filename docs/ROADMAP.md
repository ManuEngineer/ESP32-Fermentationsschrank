...
|---:|---|---|---|
| 1 | Issue #29 – ESP32-Bring-up, Partition, Ressourcen und sichere Ausgangszustaende | `ISSUE29=OPEN`; `PREVIOUS_HARDWARE_PASS=HISTORICAL` (PR #116, vor der aktuellen Gesamtbaseline); `CURRENT_DEVELOPMENT_BASE=integration/r1-development @ c1f5fbb5f19ab8e7d2c25708fe79777d523217d4`; `CURRENT_PROBE_REQUALIFICATION=FAIL_REPRODUCED_PANIC`; `PLAIN_BRINGUP_PANIC=CONFIRMED` (ohne #90-Harness; `PANIC_INDUCED_RESET=YES`, `PANIC_RESET_REASON=rst:0xc (SW_CPU_RESET)`, `UNRELATED_UNEXPECTED_RESET=NO`); `PRIMARY_DIAGNOSIS=STALE_ISSUE29_DIAGNOSTIC_STACK_BUDGET`; `ROOT_CAUSE=UNRESOLVED`; `LEVEL_GATE=DEFERRED_PENDING_STABLE_REQUALIFICATION`; `CODE_CHANGE=NO`; `PLAN=docs/tasks/issue-29-panic-requalification-correction-plan.md @ e8fe79f3d7f45ba5d92653cd504956cb0d00b8b2`. Details: Issue #29, `docs/ISSUE_29_MEASUREMENTS.md` (Abschnitt "Aktuelle Requalifikation"), vorgenannter Plan. | Owner-Review und Freigabe der exakten Plan-SHA vor jeder Umsetzung; danach digitale Stack-/Build-Gates, erneute 3/3-Hardware-Requalifikation, erst danach Pegelmessung. #29 bleibt von der #90-Power-Cut-Kampagne getrennt; #25 bleibt bis zur Owner-finalen #29-Entscheidung blockiert. |
