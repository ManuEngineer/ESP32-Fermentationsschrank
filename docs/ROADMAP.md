...
| 2 | Issue #90 – produktiver ESP-IDF-NVS-Adapter fuer `IStateStore` | `R5_9_SLICE_1_COMPLETED_PENDING_OWNER_REVIEW`; PR #118 @ `23b3c1c2401d381564492bf6a7fc82f0b0f01412`; R5.9 bleibt auf dem korrigierten PR-#116-Head `25b41ae75ef8de04576623411f068876427a87cd` ownerfreigegeben. Slice 1 synchronisiert die kanonischen Vertrags-/ADR-/Persistenz-/Recovery-/Safety-/Quality-Klarstellungen und den bestehenden Portkommentar; `STATUS_TYPES_SUFFICIENT`; keine Produktionsimplementation. R5.8 `3766e96d2e4091e26e0a33de9ed094850f0f28f7` bleibt historische, nicht ownerfreigegebene Revision; PR #117 bleibt historische OPEN/Draft-Umsetzung. Keine zweite Persistenzarchitektur. #29-Priorisierung ist kein pauschaler Blocker für #90-Software-/Hostarbeit; reale #90-Boardtests bleiben actor-free. | Ownerreview des Slice-1-Ergebnisses auf Basis der ownerfreigegebenen R5.9-Plan-SHA `baf0b2ae04cd42afa75dfa00e21d900116b38bc8`; danach separate Ownerfreigabe für Slice 2 und die weiteren Slices |
