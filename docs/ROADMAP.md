...
Der aktuelle Follow-up-Scope für #164 ist die lokale Touch-Netzwerkseite samt lokaler Anzeige der aktiven SoftAP-Zugangsdaten. Die Ownerentscheidung `VARIANT_B` deferiert die lokale HOME_WIFI-Credentialeingabe samt Bildschirmtastatur und den WLAN-QR; der browserbasierte Setup-Pfad bleibt R1. Der versionierte Plan liegt auf `BASE_MAIN=b871375f494701bed1834013cfeb789856983e3a`; `COMPLETION_PLAN_STATUS=INDEPENDENT_PLAN_FIX_VERIFICATION_REQUIRED`, `PRODUCT_IMPLEMENTATION=NOT_STARTED`.
