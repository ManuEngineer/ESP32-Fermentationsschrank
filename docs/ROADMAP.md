...
|---:|---|---|---|
| 1 | Issue #29 – ESP32-Bring-up, Partition, Ressourcen und sichere Ausgangszustaende | `ISSUE29=OPEN`; `PR129=OPEN_DRAFT`; `CURRENT_INTEGRATION_BASE=integration/r1-development @ 1fd8f6af53d1b3c23f3aa46c73c4fc3da7513d6d`; `PANIC_REPRODUCTION_SOURCE_SHA=c1f5fbb5f19ab8e7d2c25708fe79777d523217d4`; `CURRENT_BASE_CONTROL_BOOT=PANIC_REPRODUCED`; `CURRENT_BASELINE_PANIC_CONFIRMED=YES`; `CURRENT_BASE_CONTROL_SOURCE_SHA=7edda30de1d39d5a4945137146ab16da530c5dc6`; `ROOT_CAUSE=UNRESOLVED`; `DIAGNOSTIC_PROBE_TASK_STACK_BYTES=98304`; `OLD_96K_SOURCE_SHA=3d7b02260e18dd203cd609d97cc66fa96e435cdf`; `OLD_96K_ARTIFACT_STATUS=HISTORICAL_NONQUALIFYING`; `CORRECTED_96K_SOURCE_SHA=b14b5a0d9fa1ef5e1c453a6d8e32072d01dd30e6`; `ONLY_RUNTIME_RELEVANT_PROBE_CHANGE=STACK_SIZE`; `RUNTIME_LOG_FORMAT_CHANGED=NO`; `CORRECTED_96K_DIGITAL_GATES=PASS_WITH_LOCAL_ARTIFACT_PATH_FINDINGS`; `EXACT_LOCAL_GENERATED_ARTIFACT_SCAN=FAIL_PRIVATE_ABSOLUTE_PATHS`; `VALID_96K_BOOT_COUNT=0`; `OBSERVED_NONQUALIFYING_COMPLETE_RUN_COUNT=1`; `BOOT_REQUALIFICATION=NOT_STARTED_ON_CORRECTED_ARTIFACT`; `HWM_RESULT=NONQUALIFYING_SINGLE_RUN_EVIDENCE`; `CAPTURE_RESET_PROCEDURE=READY_FOR_OWNER_REVIEW`; `HARDWARE_RUN_CORRECTED_ARTIFACT=NO`; `GPIO_SSOT=config/board_profiles/esp32_32e_quad_mosfet_r1.yaml`; `GPIO_MATRIX_STATUS=PLANNED_NOT_CONFIRMED`; `ELECTRICAL_VERIFICATION=PENDING`; `LEVEL_GATE=DEFERRED_PENDING_STABLE_REQUALIFICATION`; `LEVEL_MEASUREMENTS=NOT_RUN`; `ISSUE25_STARTED=NO`; `MERGE=NO`; `NEW_PLAN_SHA=b7d80de7d6e23fd792c2bd48eaa27052a8c61201`. Details: Issue #29, `docs/ISSUE_29_MEASUREMENTS.md`, `docs/ISSUE_29_BUILD_REPORT.md`, `docs/tasks/issue-29-panic-requalification-correction-plan.md`. | Owner Full Correction Review des korrigierten digitalen Artefakts und der Capture-/Reset-Prozedur; kein Flash vor Freigabe. Pegelmessung erst nach `BOOT_REQUALIFICATION=3_OF_3_PASS` und Owner-Review. #29 bleibt von #90 getrennt; #25 bleibt zurückgestellt. |
