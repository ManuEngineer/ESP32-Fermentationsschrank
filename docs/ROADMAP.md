...
| 2 | Issue #90 – produktiver ESP-IDF-NVS-Adapter fuer `IStateStore` | `ISSUE90=OPEN`; `PR128=DRAFT`; `CURRENT_R1_DEVELOPMENT_BASE=integration/r1-development`; `PR123=MERGED`; `SLICE7_CURRENT_BASELINE_COMPATIBILITY=CHANGES_REQUIRED` (Phase-A-Audit gegen #121/#124/#126: Harness persistiert Run-Starts noch mit `utcUnixSeconds=nullopt`, seit #126 vom Trusted-UTC-Schreibgate blockiert; Runner-Oracle-`KNOWN_DISPOSITIONS` fehlt `RecoveryEvaluation`); `HARDWARE_CAMPAIGN=STOP_PENDING_CORRECTION_PR`; kanonischer Korrekturplan: `docs/tasks/issue-90-slice7-host-utc-seam-correction-plan.md @ cdb19e52479db8a0db83270811c73910842c9393` (KISS, Owner-Ownerfreigabe der Plan-SHA ausstehend); historischer R5.9-Plan bleibt Grundlage: `docs/tasks/issue-90-clean-restart-plan-r5.9.md @ baf0b2ae04cd42afa75dfa00e21d900116b38bc8`. | Owner-Freigabe der Plan-SHA `cdb19e5`; danach kleine Harness-/Runner-Korrektur, digitale Gates, dann physische NVS-/Power-Cut-Kampagne (3x config, 3x run) mit manuellem ROM-Bootloader, Backup/Restore und Normalboot-Provenienz. |
