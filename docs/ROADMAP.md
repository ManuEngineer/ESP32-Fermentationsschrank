...
|---:|---|---|---|
| 1 | Issue #29 – ESP32-Bring-up, Partition, Ressourcen und sichere Ausgangszustaende | `IMPLEMENTATION_IN_PR; HARDWARE_BLOCKED`; Plan `docs/tasks/issue-29-implementation-plan.md @ 4f49b44cff47f55bfd425d9e39c5a07256782ed7` freigegeben, Software-/Buildimplementation und Reviewkorrekturen liegen in Draft-PR #116. Die Baseline bleibt aktorfrei. #29 bleibt Prioritaet 1 und blockiert #90. | Software-Review abschliessen; danach reale Board-, Flash-, Boot-, UART-, Recovery-, Smoke- und Ressourcenmessungen auf verifiziertem Ziel |
