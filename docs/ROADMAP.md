...
| 6 | Issue #126 – R1-Absolute-Zeitplattform mit DS3231SN und ESP-IDF-SNTP | `PLAN_ONLY`; `IMPLEMENTATION=NOT_STARTED`; `MERGE=NO`; `OWNER_PLAN_REVIEW_REQUIRED=YES`; `OWNER_DECISIONS_REQUIRED=NONE`; `RTC_DEVICE=DS3231SN`; `RTC_FAMILY=DS3231`; `R1_RTC_VARIANT=DS3231SN`; `RTC_HARDWARE_OPTIONAL=YES`; `NTP_ONLY_MODE_SUPPORTED=YES`; `NEW_PRODUCTIVE_RUN_START_REQUIRES_TRUSTED_UTC=YES`; `R1_CURRENT_FERMENTING_CHECKPOINT_REQUIRES_TRUSTED_UTC=YES`; `PERIODIC_FERMENTING_CHECKPOINT_WITHOUT_TRUSTED_UTC=SKIP_NO_WRITE`; `WRITE_INVARIANT_TIGHTENED=YES`; `DS3231SN_LIBRARY_COMPATIBILITY=TO_BE_VERIFIED_BY_ESP_IDF_6_0_2_BUILD_AND_TARGETED_TESTS`; `DS3231M_R1_SUPPORT=NO`; `MULTI_RTC_VARIANT_SUPPORT_R1=NO`; `I2C_PORT_LIFETIME_OWNER=I2CDEV`; `RTC_HARDWARE=BLOCKED_OWNER_HARDWARE_PENDING`; `NTP_REAL_NETWORK_RUN=NOT_RUN`; kanonischer Plan: `docs/tasks/issue-126-absolute-time-rtc-ntp-plan.md @ 52bd69f37e7baac782ebd2fb927f3fa57003f1c7`; #89 bleibt Connectivity-Eigentümer, #124 bleibt fachlich unverändert. | Owner-Review des exakten Plan-Commits; danach nur mit Freigabe umsetzen. |
