...
| 6a | Issue #130 – R1-GPIO-Zielmatrix und Verdrahtungsbasis | `ISSUE130=OPEN`; `PR131=OPEN_DRAFT`; `PLAN_STATUS=PLAN_ONLY`; `GPIO_MATRIX=PLANNED_NOT_CONFIRMED`; `HARDWARE_RUN=NOT_RUN`; Plan: `docs/tasks/issue-130-r1-gpio-matrix-plan.md @ PENDING_OWNER_REVIEW`; #29/PR129 sowie #30/#31/#32/#33 bleiben getrennte Hardware-/Verifikationsgates. | Exakte Plan-SHA durch Owner freigeben; danach ausschließlich die kanonischen Hardware-/YAML-Dokumente gemäß Plan synchronisieren. Keine Aktorfreigabe und kein `confirmed_test` durch diesen PR. |
