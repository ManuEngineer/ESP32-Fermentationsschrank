...
| 1 | Issue #27 / PR #167 – Web/API/Auth | `PLAN_FIRST=YES`; `BASE_SHA=b8d963e8d830b95b160dfb7e5cc9c2d033ad53e9`; `PREVIOUS_APPROVED_PLAN_SHA=da30f0526b6ffd76e51297d00291afe5808a4815`; `PLAN_STATUS=DRAFT_OWNER_APPROVAL_REQUIRED`; `IMPLEMENTATION_AUTHORIZATION=NO`; `APPLICATION_RUNTIME_EVIDENCE_PREDECESSOR_ISSUE=168`; `APPLICATION_RUNTIME_EVIDENCE_PREDECESSOR_PR=169`; `APPLICATION_RUNTIME_EVIDENCE_MAIN=b8d963e8d830b95b160dfb7e5cc9c2d033ad53e9`; `APPLICATION_RUNTIME_EVIDENCE_STATUS=AVAILABLE`; `KDF_MEASUREMENT=BLOCKED_FT232_DISCONNECTED`; `KDF_WORK_FACTOR=NOT_SELECTED`; `KDF_RUNTIME=FAIL_CLOSED_WHILE_WORK_FACTOR_UNAPPROVED`; `ARDUINOJSON_RESOURCE_EVIDENCE=PENDING`; `ACTUATOR_RELEASE=NO`. | Unabhaengiger Plan Review der neuen exakten Plan-SHA; danach nur nach Ownerfreigabe die #27-Implementation fortsetzen |
