...
| 2 | Issue #90 – produktiver ESP-IDF-NVS-Adapter fuer `IStateStore` | `CLEAN_RESTART_PLAN_DRAFT_PENDING_R5_9_OWNER_APPROVAL`; R5.9 wird auf dem korrigierten PR-#116-Head `25b41ae75ef8de04576623411f068876427a87cd` abgeleitet. R5.8 `3766e96d2e4091e26e0a33de9ed094850f0f28f7` bleibt historische, nicht ownerfreigegebene Revision; PR #117 bleibt historische OPEN/Draft-Umsetzung. Keine zweite Persistenzarchitektur. #29-Priorisierung ist kein pauschaler Blocker für #90-Software-/Hostarbeit; reale #90-Boardtests bleiben actor-free. | Ownerfreigabe der exakten neuen R5.9-Plan-SHA; danach separat gegatete Recovery-Orakel-, Backend-zu-Produkt-Recovery-, Bestands-, Minimalfix-, NVS-, Software- und actor-free Board-Slices |
