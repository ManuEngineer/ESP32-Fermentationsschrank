...
- Issue #89 (WLAN-Onboarding-Evaluation) bleibt vor Beginn planpflichtig; Issue
  ...
  immutable. Der aktuelle Status bis zur separaten Slice-1-Freigabe ist
  `SLICE_1_PENDING_OWNER_APPROVAL`. Implementierung,
