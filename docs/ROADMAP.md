...
| 4 | Issue #121 – Release-1 Device-/Application-Lifecycle- und Safety-Policy-Vereinfachung | `IMPLEMENTATION=IN_PROGRESS_BLOCKED_BEFORE_STEP_6`; Schritte 1–5 ownerreviewt PASS, `STEP_5_EFFECTIVE_SOURCE_SHA=7049380d0e4bd9c0522c4475fa156febcd63ed5d`. Kanonischer R1-Plan `docs/tasks/issue-121-lifecycle-safety-simplification-plan.md @ 9c98bab20b834695be5a43c34f3385fa7b140a66`; `PRIOR_APPROVED_PLAN_SHA=e249b51cedf6f6a3edbce3a0889c48d77b79e828`, `PRIOR_REVIEWED_CORRECTION_SHA=9b101295af6468878057758356de33848ec18061`, `OWNER_PLAN_REVIEW=PENDING`. `BOOT_CLASSIFICATION_CONFIGURATION_AUTHORITY=NO`, `BOOT_CLASSIFICATION_RUN_LOAD_AUTHORITY=YES`, `CONFIG_RUNTIME_LEASE_GATE_PRECEDES_RUN_LOAD=YES`, `APPLICATION_LIFECYCLE_SINGLE_SOURCE=ApplicationLifecycleState`, `APPLICATION_READY_EQUALS_ACTUATION_ALLOWED=NO`. Architekturgrenze unverändert: `FERMENTATION_APP_DEPENDS_ON_DEVICE_PLATFORM_ESP_IDF=NO`, Resolver-Owner ist die ESP-IDF-Composition-Root, Native-Smoke-Overload bleibt erhalten. `IMPLEMENTATION_STEP_6=NOT_STARTED`, `IMPLEMENTATION_STEP_6_GATE=BLOCKED_PENDING_REVISED_PLAN_OWNER_REVIEW`, `STEP_6_SOURCE_SHA=NOT_CREATED`, `IMPLEMENTATION_STEP_7=NOT_STARTED`, `PR120=OPEN_DRAFT_FROZEN`, `PLAN_INTERNAL_CONFLICT=NONE`, `SOURCE_OF_TRUTH_CONFLICT=NONE`, `PRODUCTION_CODE_CHANGE=NO`, `TEST_CODE_CHANGE=NO`, `HARDWARE_RUN=NO`. | STOP – Owner Full Review der neuen exakten Plan-SHA `9c98bab20b834695be5a43c34f3385fa7b140a66`; keine Implementation beginnen. |
