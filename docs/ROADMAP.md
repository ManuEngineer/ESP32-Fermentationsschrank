...
| 4 | Issue #121 – Release-1 Device-/Application-Lifecycle- und Safety-Policy-Vereinfachung | `IMPLEMENTATION=IN_PROGRESS_BLOCKED_BEFORE_STEP_6`; Schritte 1–5 ownerreviewt PASS, `STEP_5_EFFECTIVE_SOURCE_SHA=7049380d0e4bd9c0522c4475fa156febcd63ed5d`. Kanonischer R1-Plan `docs/tasks/issue-121-lifecycle-safety-simplification-plan.md @ 3bf360fd81c885808c5aa299c0e5b41769cd26cc`; `PRIOR_APPROVED_PLAN_SHA=e249b51cedf6f6a3edbce3a0889c48d77b79e828`, `PRIOR_REVIEWED_CORRECTION_SHA=9b101295af6468878057758356de33848ec18061`, `PLAN_CORRECTION_REASON=FERMENTATION_APP_MUST_NOT_DEPEND_ON_DEVICE_PLATFORM_ESP_IDF`, `OWNER_PLAN_REVIEW=PENDING`. Die Architekturgrenze bleibt unverändert: `FERMENTATION_APP_DEPENDS_ON_DEVICE_PLATFORM_ESP_IDF=NO`, Resolver-Owner ist die ESP-IDF-Composition-Root, Native-Smoke-Overload bleibt erhalten. `IMPLEMENTATION_STEP_6=NOT_STARTED`, `IMPLEMENTATION_STEP_6_GATE=BLOCKED_PENDING_REVISED_PLAN_OWNER_REVIEW`, `STEP_6_SOURCE_SHA=NOT_CREATED`, `IMPLEMENTATION_STEP_7=NOT_STARTED`, `STEP5_STEP6_SCOPE_HISTORY_CONFLICT=CLOSED`, `SOURCE_OF_TRUTH_CONFLICT=NONE`, `PRODUCTION_CODE_CHANGE=NO`, `TEST_CODE_CHANGE=NO`, `FIRMWARE_TESTS=NOT_RUN_PLAN_ONLY`, `HARDWARE_RUN=NO`. | STOP – Owner Full Review der neuen exakten Plan-SHA `3bf360fd81c885808c5aa299c0e5b41769cd26cc`; keine Implementation beginnen. |
