...
| 4 | Issue #121 – Release-1 Device-/Application-Lifecycle- und Safety-Policy-Vereinfachung | `STEP_4_IMPLEMENTED_OWNER_REVIEW_PENDING`; begrenzte Vereinfachung von Device/Application Lifecycle, Process Lifecycle, Actuation Permission, Boot Classification und Persistence Technical Result gemaess Ownerkorrekturen A-J zum Architektur-Audit. Kein Wire-/Schema-Bruch, keine neue Aktorfreigabe, produktiver Composition-Scope actor-free. Draft-PR #122 auf Basis PR-#118-HEAD (`fd7e4e3`), nicht auf der eingefrorenen PR-#120-Implementation. Plan `docs/tasks/issue-121-lifecycle-safety-simplification-plan.md @ e249b51` (R1, sechsfach in-place korrigiert nach Ownerkorrekturauftraegen zu `ea4f057`, `666525e`, `fdb240a`, `cd64c8f`, `117b0d4` und `658873c`; Runde 6 hat einen real gefundenen Entwurfsfehler im eigenen Runde-5-Reset korrigiert – `destination = T{};` ist als Zuweisungs-RHS keine C++17-elidierbare Initialisierung, field-by-field-Reset ersetzt es). `MATERIAL_ARCHITECTURE_DECISION_OPEN=NO`: der Plan enthaelt keine offene Architekturalternative. `OWNER_PLAN_REVIEW=PASS`, `APPROVED_PLAN_SHA=e249b51cedf6f6a3edbce3a0889c48d77b79e828`, `OWNER_STEP_2_REVIEW=PASS`, `OWNER_STEP_3_REVIEW=PASS`, `OWNER_STEP_4_REVIEW=PENDING`, `IMPLEMENTATION_STEP_1=PASS`, `STEP_1_SOURCE_SHA=cbfd81e1a622da6f241b89ca43636f41bf798ada`, `IMPLEMENTATION_STEP_2=PASS`, `STEP_2_SOURCE_SHA=6f0d6341c4ae37634fdacb8df09650b8b0c8212d`, `STEP_2_PRODUCT_REACHABILITY=NO`, `PRODUCT_REACHABLE_STATIC_STACK_GATE=NOT_RUN_STEP_2`, `IMPLEMENTATION_STEP_3=PASS`, `STEP_3_SOURCE_SHA=eda125791eda5bfb6ec7125b7392ea971f3c8ec0`, `IMPLEMENTATION_STEP_4=PASS`, `STEP_4_SOURCE_SHA=8bf3592e77d6d8841dd2a572cbbd3bce2da22b81`, `PLAN_DEVIATION=NONE`, `IMPLEMENTATION=STEP_4_OWNER_REVIEW_PENDING`, `IMPLEMENTATION_STEP_5=NOT_STARTED`, `SOURCE_OF_TRUTH_CONFLICT=NONE`. | Umsetzungsschritt 4 ist abgeschlossen; danach Owner Review vor Schritt 5. |
