...
| 6a | Issue #130 – R1-GPIO-SSOT und Synchronisierung der Hardware-Issues | `ISSUE130=OPEN`; `PR131=OPEN_DRAFT`; `PLAN_APPROVED=PASS`; `PLAN_APPROVED_SHA=8dff244c01dc21228e5c4c355925add522da33b8`; `REAL_HARDWARE_PRESENT=YES`; `BOARD_FAMILY_REFERENCE_MATCH=CONFIRMED_BY_OWNER`; `BOARD_FAMILY=esp32_32e_quad_mosfet`; `MCU_MODULE=ESP32-WROOM-32E`; `BOARD_REVISION=TBD_HARDWARE`; `ADR002_AMENDMENT=IMPLEMENTED_IN_PR`; `GPIO_MATRIX=UNCHANGED`; `GPIO_MATRIX_STATUS=PLANNED_NOT_CONFIRMED`; `ELECTRICAL_VERIFICATION=PENDING`; `ISSUE130_PLAN_SCOPE_SYNC=PASS`; `GPIO_SSOT=IMPLEMENTED_IN_DRAFT_PR`; `IMPLEMENTATION=COMPLETE_IN_DRAFT_PR`; `SSOT_IMPLEMENTED_IN_PR=COMPLETE`; `SSOT_MERGED_TO_INTEGRATION=NO`; `ISSUE_SYNC=PLANNED`; `POST_MERGE_ISSUE_SYNC=PLANNED`; `ISSUES_SYNCHRONIZED_POST_MERGE=NOT_STARTED`; `EXTERNAL_RESISTORS=OWNER_APPROVED_AS_SPECIFIED`; `HARDWARE_RUN=NOT_RUN`; `OWNER_FULL_IMPLEMENTATION_REVIEW_REQUIRED=YES`; `MERGE=NO`; Plan: `docs/tasks/issue-130-r1-gpio-matrix-plan.md @ 8dff244c01dc21228e5c4c355925add522da33b8`; #29/PR129 sowie #30/#31/#32/#33 bleiben bis nach dem Owner-Merge getrennte Hardware-/Verifikationsgates. | Owner-Full-Implementation-Review des Draft-PR gegen Plan und Diff erforderlich; danach entscheidet ausschließlich der Owner über Ready/Merge. Post-Merge-Issue-Sync erst gegen die reale Merge-SHA; kein `confirmed_test` oder Aktorfreigabe durch diese Umsetzung. |
