...
| 5 | Issue #124 – R1-Stromausfall-Recovery auf einfachen Zeitvertrag konsolidieren | `PLANNED_SPEC_PENDING`; `REPLACES_R1_NO_FERMENTING_RESUME_POLICY=YES`; `TEMPERATURE_WEIGHTED_RECOVERY_R1=NO`; kanonischer Plan: `docs/tasks/issue-124-r1-power-loss-recovery-plan.md @ 7c10b74ce87ae25e26c44d8fc5e7c944be434dd4`; #18/#24 bleiben historische Provenienz. | Owner-Freigabe des exakten Plan-Commits; danach getrennte Recoveryumsetzung vor #25 |
