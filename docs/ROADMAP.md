...
|---:|---|---|---|
| 0 | Issue #89 – WLAN-Onboarding und Provisionierung evaluieren | `PLAN_FIRST=YES`; `PLAN_REVISION=ESP_IDF_6_1_PHASE_B_PROPORTIONAL_OWNER_GATE`; `BASE_SHA=7029df3997bb92e60379eb218f1894f86c5f7d55`; `CURRENT_PLAN_SHA=PLAN_REVISION_COMMIT_RECORDED_IN_PR_AND_SESSION_HANDOVER`; `APPROVED_PLAN_SHA=6a0a83b3b037c47b89caa87f9d2cb1e65f498c59`; `PARENT_APPROVED_PLAN_SHA=5c582aa179cd6e382dc4442a6824bb79a1e2b22f`; `PLAN_STATUS=OWNER_APPROVAL_REQUIRED`; `HISTORICAL_PLAN_SHA=d8d506da1d5bde129c09d623263d7657c38f28a3`; `HISTORICAL_PHASE_A_6_0_2_EVIDENCE=PASS`; `PHASE_A_6_1_REVALIDATION=PASS`; `A5_6_1_SOURCE_MANIFEST_LICENSE_SCREEN=PASS`; `WIFIMANAGER_NATIVE_IDF_6_1_SPIKE=CAPABILITY_NOT_PRESENT_FOR_CURRENT_NATIVE_IDF_GATE`; `PHASE_A_EVIDENCE_SOURCE_SHA=aa0d231e9b97cfe489b69b27d0b1ab5dcd28c775`; `PHASE_B_TEST_RUN_HEAD=7d68c66589ffffe2ca943eb3583189207b8fdd87`; `PHASE_B_FIRMWARE_SOURCE_SHA=7d68c66589ffffe2ca943eb3583189207b8fdd87`; `CURRENT_ESP_IDF=v6.1@fff9895c82d744c7237be8847347bdd1b07c6643`; `PHASE_B_TEST_SETUP=OWNER_AUTHORIZED`; `DEV_BOARD_DISPOSABLE=YES`; `FLASH_OVERWRITE_ALLOWED=YES`; `NVS_ERASE_ALLOWED_FOR_TEST=YES`; `EXISTING_DEV_STATE_PRESERVATION_REQUIRED=NO`; `PRE_TEST_FLASH_BACKUP_REQUIRED=NO`; `POWER_CUT_TESTS_REQUIRED=NO`; `POWER_CUT_TESTS=WAIVED_BY_OWNER`; `UART_RESET_TESTS_ALLOWED=YES`; `FLASH_TESTS_ALLOWED=YES`; `REAL_CLIENT_TESTS_ALLOWED=YES`; `EFUSE_WRITE=NO`; `SECURE_BOOT_CHANGE=NO`; `FLASH_ENCRYPTION_CHANGE=NO`; `ROM_DOWNLOAD_MODE_DISABLE=NO`; `PHASE_B_LOCAL_TEST_CREDENTIAL=EPHEMERAL_UNTRACKED_OVERRIDE`; `PHASE_B_SECRET_REDACTION=PASS`; `PHASE_B_FLASH_BOOT_EVIDENCE=PASS`; `PHASE_B_CLIENT_EVIDENCE=PASS_MINIMAL_PROPORTIONAL_WITH_CANDIDATE_GAPS`; `ANDROID_CLIENT_EVIDENCE=PASS`; `ANDROID_DIRECT_IP_TEST=PASS`; `ANDROID_CAPTIVE_PORTAL_AUTO_OPEN=NOT_OBSERVED`; `OFFICIAL_NETWORK_PROVISIONING_SOFTAP=PASS`; `OFFICIAL_BROWSER_R1_CONTRACT=GAP`; `DIRECT_PROTOCOMM_SOFTAP=PASS`; `DIRECT_PROTOCOMM_BROWSER_R1_CONTRACT=GAP`; `NATIVE_HTTP_SOFTAP=PASS`; `NATIVE_HTTP_BROWSER_TRANSPORT=PASS`; `IOS_CLIENT_EVIDENCE=WAIVED_BY_OWNER`; `WINDOWS_CLIENT_EVIDENCE=WAIVED_BY_OWNER`; `PHYSICAL_DISPLAY_QR_TEST=DEFERRED_NOT_BLOCKING_ISSUE89_SELECTION`; `PHASE_B_COMPARABLE_CLIENT_EVIDENCE=PASS_MINIMAL_PROPORTIONAL`; `PHASE_B_RUNTIME_RESOURCE_EVIDENCE=PASS_AT_TRANSPORT_START`; `CLIENT_LOAD_RUNTIME_EVIDENCE=DEFERRED_AFTER_SELECTION`; `OWNER_CANDIDATE_SELECTION_GATE=READY_FOR_OWNER_DECISION`; `IMPLEMENTATION=SPIKE_ONLY_EVIDENCE`; `EVIDENCE=docs/audits/ISSUE_89_WLAN_ONBOARDING_EVIDENCE.md`; `CANDIDATE_SELECTION=OWNER_DECISION_PENDING`; `PRODUCTIVE_CONNECTIVITY_PERSISTENCE=NOT_STARTED`; `ACTUATOR_RELEASE=NO`. Keine neue Sensor-, Display- oder Aktorverkabelung fuer Host-/actor-free Evidence; Android-Evidence ist ausreichend, iOS/iPadOS und Windows sind ownerseitig waived, der physische QR-Test deferred und Kandidatengaps bleiben dokumentierte Produkt-/Integrationsluecken. | Drei Kandidaten real bewertet; Android/Linux-Host PASS, Official/Direct Browser-R1 GAP, Native HTTP-Transport PASS; keine weiteren Client-/Hardwaretests vor dem Owner-Kandidatengate; nach exakter neuer Planfreigabe `READY_FOR_OWNER_DECISION`; keine produktive Integration |
