...
|---:|---|---|---|
| 0 | Issue #159 – ESP-IDF 6.0.2 auf 6.1 aktualisieren | `ISSUE159=OPEN`; `PR160=DRAFT`; `PLAN_FIRST=YES`; `PLAN_APPROVAL=APPROVED`; `APPROVED_PLAN_SHA=8b181954949fe32d32a26312f8eefe415f65acd1`; `IMPLEMENTATION=IN_PROGRESS`; `FULL_PROFILE_BUILDS=DEFERRED_TO_OWNER_AUTHORIZED_FULL_UPGRADE_PRE_READY`; `FULL_ESP_CLANG=DEFERRED_TO_OWNER_AUTHORIZED_FULL_UPGRADE_PRE_READY`; `HARDWARE_PARITY=ISSUE29_QUALIFIED_BOARD_UART_SAFE_SMOKES_PLUS_ISSUE90_POWER_CUT_RESTORE_PRODUCT_BOOT`; `TARGET=v6.1@fff9895c82d744c7237be8847347bdd1b07c6643`; `ACTUATOR_RELEASE=NO`; PR #158 bleibt unveraendert ausserhalb des Scopes. | Gezielte Builder-Pruefungen und danach Independent Review; vollstaendige Upgrade-/Pre-Ready-Nachweise erst nach Review und Owner-Autorisierung |
