...
| 2 | Issue #24 – Fehlerklassen, Verriegelung, SAFE_BOOT und Fehlerinjektion | PR #110 ist Draft; der Owner Scope Reset vom 2026-08-17 hat die vorherigen Planstände als superseded/not approved abgelöst; die neue vollständige Planrevision `docs/tasks/issue-24-safety-core-replan.md` ist mit `e3aeb92f9c6e8258b2b1d3e99d317a990108b8f2` committed und schließt F1–F6 einschließlich der kanonischen `IStateStore`-/`writeExact()`-Semantik und der Live-Issue-Synchronisierung; Implementation NOT_STARTED | Owner-Review der exakten Plan-SHA `e3aeb92f9c6e8258b2b1d3e99d317a990108b8f2` |
