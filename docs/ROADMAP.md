...
`PROBE_FAIL_CLOSED_GT_60S=NOT_VERIFIED`; `ACTUATOR_RELEASE=NO`. Der Owner hat zusaetzlich die Umstellung des aktiven Host-`clang-format`/`clang-tidy`-Vertrags von Major 18 auf Major 21 in PR #156 freigegeben. Der materielle Toolchain-Schnitt ist in `docs/tasks/issue-31-display-rotation-capture-correction-plan.md`, Abschnitt 9, mit `HOST_CLANG21_PLAN_SHA=c2b2dfa8635eb4077efd8bc6d6a3ce87604724c8` festgehalten; die Umsetzung ist wegen neuer nichttrivialer Clang-21-Befunde vor Sourceänderungen gestoppt.
