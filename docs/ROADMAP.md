...
| 6 | Issue #126 – R1-Absolute-Zeitplattform mit DS3231 und ESP-IDF-SNTP | `PLAN_ONLY`; `IMPLEMENTATION=NOT_STARTED`; `MERGE=NO`; `OWNER_PLAN_REVIEW_REQUIRED=YES`; `OWNER_DECISIONS_REQUIRED=NONE`; `RTC_HARDWARE_OPTIONAL=YES`; `NTP_ONLY_MODE_SUPPORTED=YES`; `NEW_PRODUCTIVE_RUN_START_REQUIRES_TRUSTED_UTC=YES`; `R1_CURRENT_FERMENTING_CHECKPOINT_REQUIRES_TRUSTED_UTC=YES`; `PERIODIC_FERMENTING_CHECKPOINT_WITHOUT_TRUSTED_UTC=SKIP_NO_WRITE`; `WRITE_INVARIANT_TIGHTENED=YES`; `I2C_PORT_LIFETIME_OWNER=I2CDEV`; `RTC_HARDWARE=BLOCKED_OWNER_HARDWARE_PENDING`; `NTP_REAL_NETWORK_RUN=NOT_RUN`; kanonischer Plan: `docs/tasks/issue-126-absolute-time-rtc-ntp-plan.md @ 9623a5a69764f372e6e7c35c87428ae5bbf6bd21`; #89 bleibt Connectivity-Eigentümer, #124 bleibt fachlich unverändert. | Owner-Review des exakten Plan-Commits; danach nur mit Freigabe umsetzen. |
