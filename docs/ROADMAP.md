...
| 4 | Issue #121 – Release-1 Device-/Application-Lifecycle- und Safety-Policy-Vereinfachung | `PLAN_CORRECTION_PENDING_OWNER_REVIEW`; kanonischer Plan `docs/tasks/issue-121-lifecycle-safety-simplification-plan.md @ 3fb4d17418d449818b4f941f99e261525e25a54d`; Schritte 1–7 sind PASS und ownerreviewt. Die bisherige Behandlung des ESP-IDF-Defaults `3584 B` als hartes Produktbudget ist aufgehoben. Release-1-Basisentscheidung: `MAIN_TASK_STACK_CONFIG_SOURCE=sdkconfig.defaults`, `CONFIG_ESP_MAIN_TASK_STACK_SIZE=16384`, `BRINGUP_RELEASE_DUPLICATE_STACK_SETTING=NO`, `MAIN_TASK_STACK_BASIS=MEASURED_AND_STATICALLY_VERIFIED`, `STACK_MICRO_OPTIMIZATION_TO_3584_REQUIRED=NO`; statische Evidenz: `STATIC_RELEASE_MAX_PATH=10576 B`, Reserve `5808 B`, Bring-up `10544 B`/`5840 B`; Viability-Evidenz aus drei Release-Zyklen: `STACK_HIGH_WATERMARK_REMAINING_MIN=8904 B`, `MIN_FREE_HEAP=237740 B`, `MINIMUM_FREE_HEAP=233896 B`, `MIN_LARGEST_FREE_8BIT_BLOCK=110592 B`, `RESOURCE_DEGRADATION=NONE_OBSERVED`, keine Panics/Watchdogs/Brownouts/unerwarteten Resets. `RESOURCE_DETAIL_CONFLICT=RESOLVED`. Die vor der Korrektur akzeptierte Step-8-Implementation aus `STEP_8_PRE_CORRECTION_SOURCE_SHA=2cedf885e0916df784764ff050fa54b96e1aec1c` bleibt erhalten; `STEP_8_POST_PLAN_CORRECTION_IMPLEMENTATION=NOT_STARTED`. Diese vorhandenen Nachweise ersetzen nicht die finale Requalifikation nach der späteren produktiven Stack-Konfigurationsänderung; WLAN, LVGL/Display und Web sind noch nicht ressourcenmäßig freigegeben. Diese Runde ändert weder Produktions-/Testcode, SDK-Konfiguration, Resume-/UTC-/NTP-/Checkpoint-/Recovery-Verträge noch Hardwarezustand; der WIP-Branch bleibt unangetastet. | Ownerreview der exakten korrigierten Plan-SHA; danach separat freigegebene Stack-Konfigurationsänderung ausschließlich in `sdkconfig.defaults` und finale Schritt-8-Requalifikation. Keine Umsetzung, kein Hardwarelauf und kein Merge durch den Agenten. |
