...
|---:|---|---|---|
| 0 | Issue #89 – WLAN-Onboarding und Provisionierung evaluieren | `PLAN_FIRST=YES`; `PLAN_REVISION=APPROVED_FOR_PHASE_A`; `BASE_SHA=7029df3997bb92e60379eb218f1894f86c5f7d55`; `CURRENT_PLAN_SHA=5c582aa179cd6e382dc4442a6824bb79a1e2b22f`; `HISTORICAL_PLAN_SHA=d8d506da1d5bde129c09d623263d7657c38f28a3`; `HISTORICAL_PHASE_A_6_0_2_EVIDENCE=PASS`; `PHASE_A_6_1_REVALIDATION=PASS`; `PHASE_A_EVIDENCE_SOURCE_SHA=0b0d125379a5fef79ca2760a101603c831dc7e7e`; `CURRENT_ESP_IDF=v6.1@fff9895c82d744c7237be8847347bdd1b07c6643`; `PHASE_B_COMPARABLE_CLIENT_EVIDENCE=PENDING`; `OWNER_CANDIDATE_SELECTION_GATE=NOT_READY`; `IMPLEMENTATION=EVIDENCE_ONLY`; `EVIDENCE=docs/audits/ISSUE_89_WLAN_ONBOARDING_EVIDENCE.md`; `CANDIDATE_SELECTION=OWNER_PENDING_AFTER_COMPARABLE_EVIDENCE`; `PRODUCTIVE_CONNECTIVITY_PERSISTENCE=NOT_STARTED`; `ACTUATOR_RELEASE=NO`. Keine neue Sensor-, Display- oder Aktorverkabelung fuer Host-/actor-free Evidence; reale Client-/QR-Nachweise separat. | Phase-B-Client-/Browser-/Recovery-/Ressourcenmatrix auf isoliertem Test-NVS; danach Owner-Gate fuer Browser-only und Kandidat; keine produktive Integration vorher |
