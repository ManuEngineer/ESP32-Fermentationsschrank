...
| 2 | Issue #27 / PR #170 – Web/API/Auth | `ISSUE27=OPEN`; `CURRENT_PR27=170`; `PR170=OPEN_DRAFT`; `PR167=SUPERSEDED_REFERENCE_ONLY`; `ACTUATOR_RELEASE=NO`. | PR #170 auf aktuellem `main` revalidieren; Owner-Gates bleiben bestehen |
