...
|---:|---|---|---|
| 0 | Issue #152 – owning Vertrag manueller Zeit-/Temperaturlauf | `ISSUE152_STATUS=IMPLEMENTATION_DRAFT`; `PR153=OPEN/DRAFT`; `PR153_HEAD=739f5526e8f9d91db79957be8077fd7b3cec31ed`; `PLAN_COMMIT=292a8096b981c2137545bb88961f92b9b7a52139`; `PLAN_APPROVED=YES`; `PLAN_FIRST=YES`; `BASE_SHA=0b8b4cc1673f40296a510fdc0d79440c616ffeb8`; `IMPLEMENTATION=COMPLETED_PENDING_INDEPENDENT_REVIEW`; `NATIVE_TESTS=PASS_TARGETED_283_OF_283`; `DOWNSTREAM_ISSUE=26`; `ACTUATOR_RELEASE=NO` | Unabhaengiger vollstaendiger Review auf dem exakten Evidence-HEAD; danach Owner-Gates |
