...
|---:|---|---|---|
| 0 | Issue #159 – ESP-IDF 6.0.2 auf 6.1 aktualisieren | `ISSUE159=OPEN`; `PR160=DRAFT`; `PLAN_FIRST=YES`; `PLAN_APPROVAL=OWNER_REQUIRED`; `REVISED_PLAN_COMMIT=8b181954a0ba77a8d67badce6e5325eff675c7f0`; `IMPLEMENTATION=NOT_STARTED`; `FULL_PROFILE_BUILDS=DEFERRED_TO_OWNER_AUTHORIZED_FULL_UPGRADE_PRE_READY`; `FULL_ESP_CLANG=DEFERRED_TO_OWNER_AUTHORIZED_FULL_UPGRADE_PRE_READY`; `HARDWARE_PARITY=ISSUE29_QUALIFIED_BOARD_UART_SAFE_SMOKES_PLUS_ISSUE90_POWER_CUT_RESTORE_PRODUCT_BOOT`; `TARGET=v6.1@fff9895c82d744c7237be8847347bdd1b07c6643`; `ACTUATOR_RELEASE=NO`; PR #158 bleibt unveraendert ausserhalb des Scopes. | Ownerfreigabe der revidierten exakten Plan-SHA; danach Independent Review vor den vollstaendigen Upgrade-/Pre-Ready-Nachweisen |
