...
|---:|---|---|---|
| 1 | Issue #89 – WLAN-Onboarding und Provisionierung evaluieren | PLAN_FIRST; PLAN_APPROVAL_REQUIRED=YES; PLAN_FIX_VERIFICATION_REQUIRED=YES; PLAN_SHA=d8d506da1d5bde129c09d623263d7657c38f28a3; IMPLEMENTATION=NOT_STARTED; CANDIDATE_SELECTION=OWNER_PENDING_AFTER_COMPARABLE_EVIDENCE; ACTUATOR_RELEASE=NO. Softwareseitig ausführbar; keine zusätzliche Sensor-, Display- oder Aktorverkabelung für Host-/actor-free Evidence, reale Client-/QR-Nachweise separat. | Independent Plan Fix Verification des exakten Plan-SHA, danach Reuse-/Capability-Screen und nur begründet shortlisted Kandidatenspikes mit Android/iOS/Windows sowie Ressourcen-, Redaction-, Persistenz- und Recovery-Evidence; anschließend Owner-Auswahlgate |
...
- Issue #89 ist die aktuelle softwareseitig ausführbare
  WLAN-Onboarding-Evaluation; der exakte Plan-Commit und die
  Ownerfreigabe bleiben vor Umsetzung erforderlich. Issue #90 ist geschlossen.
