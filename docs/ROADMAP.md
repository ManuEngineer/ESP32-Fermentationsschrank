...
|---:|---|---|---|
| 1 | Issue #89 – WLAN-Onboarding und Provisionierung evaluieren | PLAN_FIRST; PLAN_APPROVAL_REQUIRED=YES; IMPLEMENTATION=NOT_STARTED; CANDIDATE_SELECTION=OWNER_PENDING_AFTER_COMPARABLE_EVIDENCE; ACTUATOR_RELEASE=NO. Softwareseitig ausführbar; keine zusätzliche Sensor-, Display- oder Aktorverkabelung für Host-/actor-free Evidence, reale Client-/QR-Nachweise separat. | Exakter Plan-Commit, danach identischer Vier-Kandidaten-Spike mit Android/iOS/Windows sowie Ressourcen-, Redaction-, Persistenz- und Recovery-Evidence; anschließend Owner-Auswahlgate |
