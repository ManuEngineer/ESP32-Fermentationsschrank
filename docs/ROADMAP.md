...
|---:|---|---|---|
| 0 | Issue #152 – owning Vertrag manueller Zeit-/Temperaturlauf | `ISSUE152_STATUS=PLANNING`; `PR153=OPEN/DRAFT`; `PR153_HEAD=f4807890498a09b22ed44b4d44192e258053dec1`; `PLAN_COMMIT=475f5b6374e238005606c945097e0a04d20d4203`; `PLAN_FIRST=YES`; `BASE_SHA=0b8b4cc1673f40296a510fdc0d79440c616ffeb8`; `IMPLEMENTATION=NOT_STARTED`; `DOWNSTREAM_ISSUE=26`; `ACTUATOR_RELEASE=NO` | Exakten #152-Plan unabhängig reviewen und Ownerfreigabe des Plan-Commits erteilen |
