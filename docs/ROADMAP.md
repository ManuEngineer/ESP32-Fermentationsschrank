...
|---:|---|---|---|
| 0 | Issue #89 – WLAN-Onboarding und Provisionierung evaluieren | `PLAN_FIRST=YES`; `PLAN_REVISION=ESP_IDF_6_1_PHASE_B_OWNER_TEST_BOUNDARY`; `BASE_SHA=7029df3997bb92e60379eb218f1894f86c5f7d55`; `CURRENT_PLAN_SHA=6a0a83b3b037c47b89caa87f9d2cb1e65f498c59`; `PARENT_APPROVED_PLAN_SHA=5c582aa179cd6e382dc4442a6824bb79a1e2b22f`; `HISTORICAL_PLAN_SHA=d8d506da1d5bde129c09d623263d7657c38f28a3`; `HISTORICAL_PHASE_A_6_0_2_EVIDENCE=PASS`; `PHASE_A_6_1_REVALIDATION=PASS`; `A5_6_1_SOURCE_MANIFEST_LICENSE_SCREEN=PASS`; `WIFIMANAGER_NATIVE_IDF_6_1_SPIKE=BLOCKED_FOR_NATIVE_IDF_6_1_SPIKE`; `PHASE_A_EVIDENCE_SOURCE_SHA=aa0d231e9b97cfe489b69b27d0b1ab5dcd28c775`; `CURRENT_ESP_IDF=v6.1@fff9895c82d744c7237be8847347bdd1b07c6643`; `PHASE_B_TEST_SETUP=OWNER_AUTHORIZED`; `DEV_BOARD_DISPOSABLE=YES`; `FLASH_OVERWRITE_ALLOWED=YES`; `NVS_ERASE_ALLOWED_FOR_TEST=YES`; `EXISTING_DEV_STATE_PRESERVATION_REQUIRED=NO`; `PRE_TEST_FLASH_BACKUP_REQUIRED=NO`; `POWER_CUT_TESTS_REQUIRED=NO`; `POWER_CUT_TESTS=WAIVED_BY_OWNER`; `UART_RESET_TESTS_ALLOWED=YES`; `FLASH_TESTS_ALLOWED=YES`; `REAL_CLIENT_TESTS_ALLOWED=YES`; `PHASE_B_COMPARABLE_CLIENT_EVIDENCE=PENDING`; `PHASE_B_EXECUTION=NOT_RUN`; `OWNER_CANDIDATE_SELECTION_GATE=NOT_READY`; `IMPLEMENTATION=EVIDENCE_ONLY`; `EVIDENCE=docs/audits/ISSUE_89_WLAN_ONBOARDING_EVIDENCE.md`; `CANDIDATE_SELECTION=OWNER_PENDING_AFTER_COMPARABLE_EVIDENCE`; `PRODUCTIVE_CONNECTIVITY_PERSISTENCE=NOT_STARTED`; `ACTUATOR_RELEASE=NO`. Keine neue Sensor-, Display- oder Aktorverkabelung fuer Host-/actor-free Evidence; reale Client-/QR-Nachweise separat. | Owner gibt zuerst die exakte neue `CURRENT_PLAN_SHA` frei; danach vergleichbare Phase-B-Matrix mit UART-/Reset-/Client-/Recoverynachweisen; kein zusaetzliches NVS-/Power-Cut-Owner-Gate und keine produktive Integration |
