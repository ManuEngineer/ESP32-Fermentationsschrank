...
|---:|---|---|---|
| 0 | Issue #89 – WLAN-Onboarding und Provisionierung evaluieren | `PLAN_FIRST=YES`; `PLAN_REVISION=ESP_IDF_6_1_PHASE_B_OWNER_TEST_BOUNDARY`; `BASE_SHA=7029df3997bb92e60379eb218f1894f86c5f7d55`; `CURRENT_PLAN_SHA=6a0a83b3b037c47b89caa87f9d2cb1e65f498c59`; `APPROVED_PLAN_SHA=6a0a83b3b037c47b89caa87f9d2cb1e65f498c59`; `PARENT_APPROVED_PLAN_SHA=5c582aa179cd6e382dc4442a6824bb79a1e2b22f`; `PLAN_STATUS=APPROVED`; `HISTORICAL_PLAN_SHA=d8d506da1d5bde129c09d623263d7657c38f28a3`; `HISTORICAL_PHASE_A_6_0_2_EVIDENCE=PASS`; `PHASE_A_6_1_REVALIDATION=PASS`; `A5_6_1_SOURCE_MANIFEST_LICENSE_SCREEN=PASS`; `WIFIMANAGER_NATIVE_IDF_6_1_SPIKE=BLOCKED_FOR_NATIVE_IDF_6_1_SPIKE`; `PHASE_A_EVIDENCE_SOURCE_SHA=aa0d231e9b97cfe489b69b27d0b1ab5dcd28c775`; `PHASE_B_TEST_RUN_HEAD=7d68c66589ffffe2ca943eb3583189207b8fdd87`; `PHASE_B_FIRMWARE_SOURCE_SHA=7d68c66589ffffe2ca943eb3583189207b8fdd87`; `CURRENT_ESP_IDF=v6.1@fff9895c82d744c7237be8847347bdd1b07c6643`; `PHASE_B_TEST_SETUP=OWNER_AUTHORIZED`; `DEV_BOARD_DISPOSABLE=YES`; `FLASH_OVERWRITE_ALLOWED=YES`; `NVS_ERASE_ALLOWED_FOR_TEST=YES`; `EXISTING_DEV_STATE_PRESERVATION_REQUIRED=NO`; `PRE_TEST_FLASH_BACKUP_REQUIRED=NO`; `POWER_CUT_TESTS_REQUIRED=NO`; `POWER_CUT_TESTS=WAIVED_BY_OWNER`; `UART_RESET_TESTS_ALLOWED=YES`; `FLASH_TESTS_ALLOWED=YES`; `REAL_CLIENT_TESTS_ALLOWED=YES`; `EFUSE_WRITE=NO`; `SECURE_BOOT_CHANGE=NO`; `FLASH_ENCRYPTION_CHANGE=NO`; `ROM_DOWNLOAD_MODE_DISABLE=NO`; `PHASE_B_LOCAL_TEST_CREDENTIAL=EPHEMERAL_UNTRACKED_OVERRIDE`; `PHASE_B_SECRET_REDACTION=PASS`; `PHASE_B_FLASH_BOOT_EVIDENCE=PASS`; `PHASE_B_CLIENT_EVIDENCE=PARTIAL_WITH_CANDIDATE_AND_PLATFORM_GAPS`; `ANDROID_CLIENT_EVIDENCE=PASS`; `IOS_CLIENT_EVIDENCE=NOT_RUN`; `WINDOWS_CLIENT_EVIDENCE=NOT_RUN`; `PHASE_B_COMPARABLE_CLIENT_EVIDENCE=PENDING`; `PHASE_B_RUNTIME_RESOURCE_EVIDENCE=PASS_AT_TRANSPORT_START`; `CLIENT_LOAD_RUNTIME_EVIDENCE=NOT_RUN`; `OWNER_CANDIDATE_SELECTION_GATE=NOT_READY`; `IMPLEMENTATION=SPIKE_ONLY_EVIDENCE`; `EVIDENCE=docs/audits/ISSUE_89_WLAN_ONBOARDING_EVIDENCE.md`; `CANDIDATE_SELECTION=OWNER_PENDING_AFTER_COMPARABLE_EVIDENCE`; `PRODUCTIVE_CONNECTIVITY_PERSISTENCE=NOT_STARTED`; `ACTUATOR_RELEASE=NO`. Keine neue Sensor-, Display- oder Aktorverkabelung fuer Host-/actor-free Evidence; reale Client-/QR-Nachweise separat. | Android/Linux-Host und drei Kandidaten real getestet; iOS/iPadOS und Windows `NOT_RUN`, kandidatspezifische Scan/Form-/Test-/Commit-/Captive-Gaps offen; danach Independent Phase-B Review und Owner-Kandidatengate; keine produktive Integration |
