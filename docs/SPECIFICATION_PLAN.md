...
8. **Sicherheit und Fehlerbehandlung** -> `SAFETY_AND_FAULTS.md`, `SAFETY_COMPONENT_FAULTS.md`
...
Als Naechstes wird Phase 8C bearbeitet: Versorgung, Softwarefehler, sichere Zustaende und Fehlerprotokoll.
