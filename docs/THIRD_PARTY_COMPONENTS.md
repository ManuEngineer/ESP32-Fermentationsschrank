...
| JSON | ArduinoJson `7.4.3`, Tag-Commit `77771d3c07668e01d8f52acb03910c1110bb373f` | 2026-07-27 | MIT (`LICENSE.txt`, SHA-256 `4a7ee9c96b28cbf30c5bf7c2d211a0ef57179f0328e68ad7b7fa7d754b7da1a2`); `idf_component.yml` ohne transitive Runtime-Abhaengigkeit; verwendete Header/Features sind auf den bounded Codec begrenzt | `BOUNDED_CODEC_INTEGRATED`, `RESOURCE_EVIDENCE_PENDING` | produktiver bounded Web-/API-Codec; Bibliothekstypen bleiben in `web_api_codec.cpp`, keine interne Kontrollpunktpersistenz; Flash/Heap/Jitter/Fragmentierung werden vor finaler Ressourcenfreigabe noch gemessen |
...
| Auth-KDF | PBKDF2-HMAC-SHA-256 aus der fixierten mbedTLS-/ESP32-Toolchain | `KDF_ALGORITHM=PBKDF2_HMAC_SHA256`; `KDF_WORK_FACTOR=10000`; reale Laufzeitmessung fuer Ownerentscheidung abgeschlossen | Framework-/mbedTLS-Lizenz und Notices des tatsaechlich verwendeten Pakets pruefen | `OWNER_SELECTED_R1`, `EVIDENCE_COMPLETE_FOR_OWNER_DECISION`, `TARGETED_FIX_VERIFICATION_PENDING` | getrennte gesalzene Passwort-/PIN-Verifier mit 16-Byte-Salt und 32-Byte-Verifier; kein automatischer Work-Factor-Fallback; die Auswahl behauptet keine Hochsicherheit oder OWASP-Konformitaet; Security-Release-Gate fuer NVS-/Flash-Schutz bleibt unveraendert |
