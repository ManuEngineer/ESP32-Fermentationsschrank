...
| Relay-/Board-Firmware | [`rpavlyuk/ESPRelayBoard`](https://github.com/rpavlyuk/ESPRelayBoard), Commit `82c6d117` | Upstream und Lizenz 2026-07-29 geprueft; exakte Reddit-Quelle und Zielboard-Smoke-Test offen | GPL-3.0; Gesamtwerk-, Abhaengigkeits- und Verteilungspflichten vor Auswahl pruefen; GPLv3 erlaubt kommerzielle Nutzung durch Dritte | `SPIKE_REQUIRED`, `LICENSE_REVIEW_REQUIRED`, `FINAL_SELECTION_PENDING` | ernsthafter Kandidat als Board-/Pin-/Bring-up-Referenz oder GPLv3-Forkbasis; keine Codeuebernahme vor [Feature-, Hardware- und Lizenzvergleich](audits/ESPRELAYBOARD_EVALUATION.md) |
