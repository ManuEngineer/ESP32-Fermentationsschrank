...
| **#31 – Display- und Touchadapter** | zwingend fuer die einzige lokale Bedien- und Anzeigeoberflaeche | `BLOCKED_HARDWARE`; sekundaer `ADAPTER_EXISTING_LIBRARY` | #25/#26-Modelle koennen parallel reifen; fuenf Kandidaten evaluiert | Display-/Touchadapter, Kalibrierungspersistenz und Ressourcenprofil | vollstaendig | Drei-Gate-Display-Spike direkt nach minimaler Baseline und ohne #24-Abschluss; danach Ownerwahl und genau eine Bibliothek; keine weiteren lokalen Eingabe-/Anzeigeadapter; Phase 3–6 | **OD-02/OD-05:** Treiber und UI-Framework nach Messung |
...
5. Der minimale Baseline-Anteil von #29 und die aktorfreien Display-/Touch- und
   ...
   keine Vorbedingung.
6. #30/#31 benoetigen vor der Produktivadapterwahl die dokumentierten
   Drei-Gate-Spikes;
