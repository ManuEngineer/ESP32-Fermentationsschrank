...
| **#26 – lokale Touchoberflaeche** | vollstaendig R1-relevant; einzige lokale Bedien- und Anzeigeoberflaeche; OD-07-Teilentscheid bindet den spaeteren Fuenferschnitt, Issue selbst bleibt unveraendert | `CUSTOM_APPLICATION`; sekundaer `ADAPTER_EXISTING_LIBRARY` | lokale UI-Spezifikation, #25-Praesentationsmodelle/Sprachressourcen und fachliche Kommandos; Display-/Touchkandidaten nur fuer #31/OD-02 | A Navigation/Interaktion; B Standby/Programmauswahl/Start; C Programmverwaltung/Editor; D Lauf/Meldungen/Stop/Wiederanlauf; E Einstellungen/Diagnose/Service/Recovery-UI; keine Fach-, Safety-, Auth-, Persistenz- oder Aktorentscheidungen neu herleiten | Screen-/Dialog-/Aktionslogik nativ und mit simulierten Touchereignissen testbar; reales Rendering, Touchrohwerte, Kalibrierungsmessung und Pixel-/Pufferabnahme bei #31 | in A–E umsetzen: grosse Ziele, Rueckweg, Abbruch, Bestaetigung, Aufwecktouch ohne Kommando, keine notwendige Wischgeste; #25 verwenden, kein allgemeines Widget-/Layout-/UI-Framework; Rendering nach #31/OD-02, LVGL-Vergleich unter OD-05, Auth nach OD-09, Resetmechanik bei #57; microSD-/SD-Slot ohne R1-Menue, Adapter, Persistenz oder Spike | **OD-07 vollstaendig entschieden:** #19/#25–#28 geschnitten; Service-PIN hebt Safety nicht auf, Geraet bleibt ohne WLAN und SD voll bedienbar |
| **#27 – Web-API, Weboberflaeche, Anmeldung und Konflikte** | R1 als sekundaere lokale Bedienoberflaeche; OD-07-Teilentscheid bindet den spaeteren Fuenferschnitt, Issue bleibt unveraendert; sicherer Betrieb ohne WLAN/Browser | `CUSTOM_APPLICATION`; sekundaer `CONFIGURE_FRAMEWORK`, konditional `ADOPT_LIBRARY` | Fachkommandos, #25-Praesentationsmodelle, Konfigurationsrevisionen, `INetworkStatus`; `WebServer` als `FIRST_EVALUATION_CANDIDATE`/`SPIKE_REQUIRED`/`FINAL_SELECTION_PENDING`, `ESPAsyncWebServer` als `CONDITIONAL_FALLBACK`; ArduinoJson `7.4.3` spikepflichtig; OD-06-Onboarding separat | A HTTP-Transport/interne API; B Lese-Status, begrenztes Polling und aktueller Laufchart; C Mutationen mit erwarteter Revision, Konflikt-/Doppelwirkungsschutz; D responsive lokale Assets; E Anmeldung/Sessions/CSRF/Service nach OD-09; keine Server-/ArduinoJson-/Frontendtypen oder Fach-/Safetyentscheidungen im Kern/JavaScript | WLAN-/Browser-/Client-/Abbruch-/Jitter-/Last-/Ressourcentest; Pollingintervalle, Clientzahl, Antwort-/Chartgroesse und Timeouts messen; JSON-Build-/Grenz-/Fuzz-/Heapnachweis | nach Spikes und Ownerwahl: #27-A Transport/interne API, #27-B Status/Polling/aktueller Chart, #27-D schlanke lokale Assets, #27-C schreibende Kommandos erst nach OD-09, #27-E Authintegration zuletzt; keine oeffentliche externe Schreib-API, kein LWW/globaler Lock, keine WebSocket-/SSE-Reserve oder allgemeine Web-/Frontendplattform; Onboarding bleibt OD-06 | **OD-07 vollstaendig entschieden:** aktueller Chart bleibt #27-B, persistente Historie #19-B und Diagnosebericht #28-D; **OD-09** bleibt Gate vor Mutationen/Auth |
| **#28 – Diagnose, Diagramme, Service und Exporte** | R1-relevant; OD-07-Teilentscheid bindet den spaeteren Viererschnitt, Issue selbst bleibt im Audit unveraendert | `CUSTOM_APPLICATION`; technische Kandidaten bleiben hinter ihren Spike-Gates | kanonische Fach-/Sensor-/Regel-/Safety-/Persistenz-/Plattformmodelle und Mocks; #19-C-Exportinfrastruktur spaeter wiederverwenden | A passive Diagnosemodelle/Boot-Selbsttest; B Ressourcen-/Gesundheitsdiagnose; C gefuehrter Serviceablauf; D typisierter nur lesender Diagnose-/Servicebericht mit Redaction; keine Telemetrie-/Metricsplattform | A/C nativ mit Mocks; B real messen; reale Serviceaktoren erst hinter #24 und Hardwaregates | Reihenfolge: Fach-/Sensor-/Safetygrundlagen, #28-A, reale Plattform-/Persistenzmesspunkte fuer #28-B, OD-09, simulierter #28-C-Ablauf, #24-/Hardwaregates vor realen Serviceadaptern, #19-C, danach #28-D; aktueller Chart bleibt #27-B, Historie #19-B, Touch/Webdarstellung #26/#27 | **OD-07 vollstaendig entschieden;** `MEASUREMENT_REQUIRED` fuer Ressourcen, `HARDWARE_GATE_PENDING` fuer reale Aktoren, OD-09 fuer Auth; keine Bibliotheksauswahl |
...
10. Produktive schreibende Webendpunkte und reale Authentisierung bleiben bis
    zum OD-09-Vertrag gesperrt. Begrenztes Polling ist eine Funktionsrichtung;
    Intervalle, Parallelitaet, Antwort-/Chartgroessen und Ressourcenbudgets
    werden erst im Prototyp festgelegt.
