...
| **#19 – Journale, Aufbewahrung, Bereinigung, Backup und Import** | R1-relevant; Issue unveraendert | `CUSTOM_APPLICATION`; sekundaer `ADOPT_LIBRARY` | `IEventJournal`, binaeres Wireformat, OD-01-Kern; ArduinoJson bevorzugt/spikepflichtig nur extern | A Journal/Retention; B begrenzte verdichtete Historie; C Leseexport/secret-freies Backup; D vollvalidierte Vorschau/atomare Aktivierung | NVS-/Flash-/Heap-/Cut- sowie JSON-Nachweise; 5 detaillierte Laeufe/50 Zusammenfassungen Messziel | A–D geordnet; #19 veraendert keine Touchkalibrierung, die der #57-Werksreset gemaess ADR-010 behaelt; Vollimportgrenze aus maximalem externem Schema ableiten | OD-07 entschieden; Codec und Gesamtbody/Streaming bleiben Spike-Gates |
...
| **#27 – Web-API, Weboberflaeche, Anmeldung und Konflikte** | R1 als sekundaere lokale Bedienoberflaeche; Issue unveraendert | `CUSTOM_APPLICATION`; technische Kandidaten spikepflichtig | Fachkommandos, #25, `INetworkStatus`; WebServer/ArduinoJson zuerst, Async konditional; Onboarding separat | A Transport/API; B Status/Polling/Chart; C Mutationen/Konflikte; D Assets; E Auth; normale Weboberflaeche auch im geschuetzten Ersatz-WLAN | WLAN-/Client-/Jitter-/Ressourcen-/Authtests; Ersatz-WLAN-Lifecycle und offene Requests | nach Spikes; Auth vor Mutationen; Ersatz-WLAN koordiniert #27, bleibt aber eigener Netzwerklebenszyklus; Onboarding bleibt OD-06 | OD-07/OD-09 entschieden; Zeiten/Technik messen |
