...
| **#27 – Web-API, Weboberflaeche, Anmeldung und Konflikte** | R1 als sekundaere lokale Bedienoberflaeche; OD-07-Teilentscheid bindet den spaeteren Fuenferschnitt, Issue bleibt unveraendert; sicherer Betrieb ohne WLAN/Browser | `CUSTOM_APPLICATION`; sekundaer `CONFIGURE_FRAMEWORK`, konditional `ADOPT_LIBRARY` | Fachkommandos, #25-Praesentationsmodelle, Konfigurationsrevisionen, `INetworkStatus`; `WebServer` als `FIRST_EVALUATION_CANDIDATE`/`SPIKE_REQUIRED`/`FINAL_SELECTION_PENDING`, `ESPAsyncWebServer` als `CONDITIONAL_FALLBACK`; ArduinoJson `7.4.3` spikepflichtig; OD-06-Onboarding separat | A HTTP-Transport/interne API; B Lese-Status, begrenztes Polling und aktueller Laufchart; C Mutationen mit erwarteter Revision, Konflikt-/Doppelwirkungsschutz; D responsive lokale Assets; E getrennte Webpasswortpruefung, fluechtige Sessions, globale Sperrpolicy, CSRF und sitzungsgebundene Servicefreigabe gemaess OD-09; keine Server-/ArduinoJson-/Frontendtypen oder Fach-/Safetyentscheidungen im Kern/JavaScript | WLAN-/Browser-/Client-/Abbruch-/Jitter-/Last-/Ressourcentest; Pollingintervalle, Clientzahl, Antwort-/Chartgroesse und Timeouts messen; JSON- und Auth-Build-/Grenz-/KDF-/Zufalls-/Heapnachweis | nach Spikes und Ownerwahl: #27-A Transport/interne API, #27-B Status/Polling/aktueller Chart, #27-D schlanke lokale Assets, #27-C schreibende Kommandos erst nach bestandenem Auth-/CSRF-Gate, #27-E Authintegration zuletzt; keine dauerhafte Anmeldung, oeffentliche externe Schreib-API, LWW/globaler Lock, WebSocket-/SSE-Reserve oder allgemeine Web-/Frontend-/Authplattform; Onboarding bleibt OD-06 | **OD-07 und OD-09 fachlich entschieden:** aktueller Chart bleibt #27-B, persistente Historie #19-B und Diagnosebericht #28-D; KDF/Work Factor, Zufallspfad und Plattformverschluesselung bleiben technische Gates |
