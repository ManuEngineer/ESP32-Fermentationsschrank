...
|---|---|---|---|---|---|---|
| Zielframework | [Espressif ESP-IDF](https://github.com/espressif/esp-idf) | `v6.1`, Commit `fff9895c82d744c7237be8847347bdd1b07c6643` (aktive Produktionsbasis) | Apache-2.0 plus dokumentierte Drittbestandteile | bestehende Buildgrundlage (nativer Hosttestpfad ueber PlatformIO, Produktionsprofile ueber ESP-IDF); spaetere Adapter verwenden nur benoetigte APIs | Lizenz-/Notice-Dateien der tatsaechlich verwendeten ESP-IDF-Komponenten und des Firmware-Distributionswegs pruefen | `FRAMEWORK_PRESENT` |
...
| ArduinoJson | [bblanchon/ArduinoJson](https://github.com/bblanchon/ArduinoJson) | Tag `v7.4.3`, Tag-Commit `77771d3c07668e01d8f52acb03910c1110bb373f`; source tree/lock im Repository | `LICENSE.txt`: MIT, SHA-256 `4a7ee9c96b28cbf30c5bf7c2d211a0ef57179f0328e68ad7b7fa7d754b7da1a2`; `idf_component.yml` weist keine transitive Runtime-Abhaengigkeit aus; verwendete Header/Features: `JsonDocument`, `JsonObject`, `JsonArray`, bounded serialize/deserialize | bounded Web-/API-Codec ist integriert; Bibliothekstypen bleiben hinter der Codecgrenze und werden nicht in Fach-/Persistenzvertraege exportiert | reproduzierbarer ESP-IDF-v6.1-Build, native Grenz-/Negativ-/Redactionstests; integrierte Flash-/Heap-/Fragmentierungs-/Jittermessung bleibt offener Ressourcen-Gate | `BOUNDED_CODEC_INTEGRATED; RESOURCE_EVIDENCE_PENDING` |
...
| mbedTLS-/ESP-IDF-Authentisierungspfad | [Espressif ESP-IDF](https://github.com/espressif/esp-idf) und darin verwendete mbedTLS-Komponenten | fixierte ESP-IDF-/mbedTLS-Toolchain; PBKDF2-HMAC-SHA-256 mit `KDF_WORK_FACTOR=10000` ist fuer R1 ownerfreigegeben | Apache-2.0 (ESP-IDF) sowie Lizenzen/Notices der konkret verwendeten eingebetteten mbedTLS-Dateien pruefen | interne Evaluation und bereits dokumentierte Laufzeit-/Stabilitaets-Evidence fuer den KDF; keine neue Bibliothek; Zufallspfad und Security-Release-Gate fuer NVS-/Flash-Schutz bleiben getrennt | konkret verwendete Funktionen/Dateien, Versionen, Buildkonfiguration, Lizenz-/Noticepflichten und publizierten Umfang fuer den tatsaechlich verwendeten Pfad dokumentieren | `OWNER_SELECTED_R1; SOURCE_NOTICE_REVIEW_REQUIRED` |
