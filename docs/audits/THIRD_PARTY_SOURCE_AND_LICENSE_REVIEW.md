...
|---|---|---|---|---|---|---|
| Zielframework | [Espressif ESP-IDF](https://github.com/espressif/esp-idf) | `v6.0.2`, Commit `7101770dc6db2667b3c477cc31365dd1acd6db4e` (Issue #71 / PR #79, aktive Produktionsbasis) | Apache-2.0 plus dokumentierte Drittbestandteile; #90 konkret: `nvs_flash`/`esp_blockdev` mit `nvs.h`, `nvs_flash.h`, `nvs_api.cpp`, `nvs_storage.cpp`, `nvs_constants.h`, `nvs_pagemanager.cpp` und dem BDL-Hostdateisatz | bestehende Buildgrundlage und #90-NVS-Adapter; keine Herstellerdateien kopiert, der Hosttest bleibt testseitig | Lizenz-/Notice-Dateien der tatsächlich verwendeten ESP-IDF-Komponenten, des BDL-Hostimports und des Firmware-/Testartefakts vor Veröffentlichung prüfen | `FRAMEWORK_PRESENT` |
