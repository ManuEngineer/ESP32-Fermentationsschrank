...
| Espressif esp_lvgl_port | [Component Registry](https://components.espressif.com/components/espressif/esp_lvgl_port) | `2.9.0`, Component-Hash `d3c020b45c3dfc0d1706a83b63a1c34a6eb444a6e935f9afff79f92b7b94dcef` in `dependencies.lock` | Registry: Apache-2.0; Abhaengigkeit ESP-IDF >=5.2, `lvgl/lvgl >=8, <10` | bestehender produktiver Integrationsport fuer LVGL auf `esp_lcd`/`esp_lcd_touch`; #164 verwendet denselben Pfad | Registryarchiv und Apache-Lizenz vor Distribution erhalten; keine neue Port-Abhaengigkeit | `IMPLEMENTED_DIGITAL_PENDING_HARDWARE` |
...
| LVGL | [lvgl/lvgl](https://github.com/lvgl/lvgl/tree/60b614c23c816ca5edc5f2840c9945eff7da0ad4) | `9.6.0~1`, Upstream-Commit `60b614c23c816ca5edc5f2840c9945eff7da0ad4`, Component-Hash `7d82410747bbfb319531449749e940f440f8414f041f9eaba13f0d1dd7f58cdd` in `dependencies.lock` | `LICENCE.txt`: MIT; optionale Fonts und Drittkomponenten separat | bestehender produktiver LVGL-Renderer; #164 aktiviert und nutzt das vorhandene QR-Widget | gepinnte Komponentenlizenz und nur tatsaechlich aktivierte Features/Notices fuer die Distribution erfassen | `IMPLEMENTED_DIGITAL_PENDING_HARDWARE` |
| LVGL gebuendelter Nayuki-QR-Generator | [LVGL `qrcodegen.c`](https://github.com/lvgl/lvgl/blob/v9.6.0/src/libs/qrcode/qrcodegen.c) | innerhalb LVGL `9.6.0~1`, Component-Hash wie LVGL-Zeile; keine separate Dependency | `src/libs/qrcode/LICENSE.txt` und `qrcodegen.c`: Copyright Project Nayuki, MIT; Lizenz-/Urheberrechtshinweis erhalten | LVGLs `lv_qrcode`-Widget verwendet den gebuendelten Generator; kein kopierter oder selbst implementierter Encoder | LVGL-Paket mit vollstaendigem Lizenztext beziehen und Notices fuer Firmwaredistribution erhalten; keine separate Nayuki-Komponente aufnehmen | `IMPLEMENTED_DIGITAL_PENDING_HARDWARE` |
