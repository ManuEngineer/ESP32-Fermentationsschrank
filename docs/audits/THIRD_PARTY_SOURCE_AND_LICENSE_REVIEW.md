...
| ESPAsyncWebServer | [ESP32Async/ESPAsyncWebServer](https://github.com/ESP32Async/ESPAsyncWebServer) | `3.12.0`, `a008cccf`; aktiv 2026-07 | Top-Level `LICENSE`: LGPL-3.0; asynchrone TCP- und optionale JSON-Abhaengigkeiten separat | interne Evaluation; keine Auswahl | dynamische/kompilierte Verlinkung, Source-Angebot/Notices und alle Abhaengigkeiten fuer den konkreten Distributionsweg pruefen | `PUBLICATION_REVIEW_REQUIRED` |
