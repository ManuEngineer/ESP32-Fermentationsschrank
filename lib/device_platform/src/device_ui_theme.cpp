...
bool isCompleteTheme(const ThemeDescriptor& descriptor) {
    ...
    constexpr ThemeToken required[] = {
        ThemeToken::Canvas,
        ThemeToken::Surface,
        ThemeToken::PrimaryAction,
        ThemeToken::SecondaryAction,
        ThemeToken::TextPrimary,
        ThemeToken::TextSecondary,
        ThemeToken::StatusInformation,
        ThemeToken::StatusWarning,
        ThemeToken::StatusError,
        ThemeToken::Overlay,
        ThemeToken::OnCanvas,
        ThemeToken::OnSurface,
        ThemeToken::OnPrimaryAction,
        ThemeToken::OnSecondaryAction,
        ThemeToken::OnStatusInformation,
        ThemeToken::OnStatusWarning,
        ThemeToken::OnStatusError,
        ThemeToken::OnOverlay,
    };
...
ThemeResolution resolveTheme(const std::vector<ThemeDescriptor>& includedThemes,
    ...
    const auto findComplete = [&includedThemes, &catalog](
        ...
        const auto found =
            std::find_if(includedThemes.begin(), includedThemes.end(),
