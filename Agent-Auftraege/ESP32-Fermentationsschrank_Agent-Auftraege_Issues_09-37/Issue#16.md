...
```text
Arbeite im Repository `ManuEngineer/ESP32-Fermentationsschrank` ausschliesslich an Issue #16:
"[E2.1] Konfigurationsebenen, Validierung und atomare Revisionen"
...
2. Vor jeder Aenderung vollstaendig lesen
   - das aktuelle GitHub-Issue #16 inklusive Kommentare
   - `AGENTS.md`
...
6. Verbindlicher Scope von Issue #16
   - Factory-, Benutzer-, Service- und Laufkonfiguration trennen
   - Schema- und Grenzwertvalidierung
   - Vorschau vor Speicherung
   - atomare Revisionen mit letzter gueltiger Rueckfallrevision
   - ausstehende Neustartwerte ohne automatischen Neustart im Lauf
   - UTC und Zeitzone `Europe/Zurich`

7. Akzeptanzkriterien
   - ungueltige Gesamtkonfiguration wird nicht teilweise aktiviert
   - Stromunterbrechung beim Schreiben laesst mindestens eine gueltige Revision
   - aktive Laufwerte bleiben unveraendert
   - Geheimnisse sind getrennt gespeichert

8. Issue-spezifische Tests und Nachweise
   - gueltige/ungueltige Revisionen
   - Stromunterbrechung
   - Rueckfall
   - Neustartbedarf
...
10. Mindestpruefungen vor einem PR
    ...
    - alle in Issue #16 neu eingefuehrten Tests
...
11. Pull Request
    ...
    - `Closes #16` nur bei vollstaendig erfuellter Definition of Done; sonst `Refs #16`.
...
Implementierung, Tests und Dokumentation abgeschlossen.
