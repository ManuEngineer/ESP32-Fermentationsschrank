# Agent-Auftrag fuer Issue #22

## Issue

**[E3.3] Zeitproportionale PI-Regelung und Luftbegrenzung**  
Aktueller Snapshot-Status: `PLANNED_SPEC_PENDING`  
Epic: #5  
GitHub: https://github.com/ManuEngineer/ESP32-Fermentationsschrank/issues/22
...
```text
Arbeite im Repository `ManuEngineer/ESP32-Fermentationsschrank` ausschliesslich an Issue #22:
"[E3.3] Zeitproportionale PI-Regelung und Luftbegrenzung"
...
2. Vor jeder Aenderung vollstaendig lesen
   - das aktuelle GitHub-Issue #22 inklusive Kommentare
   - `AGENTS.md`
...
5. Branch
   ...
   `feat/issue-22-zeitproportionale-pi-regelung-und-luftbegrenzung`

   Keine Aenderungen direkt auf `main`. Keine anderen Issues in diesen Branch aufnehmen.

6. Verbindlicher Scope von Issue #22
   - PI-Reglerkern mit Anti-Windup
   - neutraler Bereich und begrenzter Ausgang
   - vier Maschinenparametersaetze: Luft/Produkt x Heizen/Kuehlen
   - Produktregelung mit frueher Luftbegrenzung
   - Luftregelung als eigener Modus
   - Zielqualifikation mit Gnadenzeit
   - keine vollstaendige Kaskadenregelung oder PID-Autotuning in Release 1

7. Akzeptanzkriterien
   - Regler liefert nur abstrakte Anforderung `HEAT`, `OFF`, `COOL` plus Zeitquote
   - Integrator bleibt bei Sperren kontrolliert
   - Produkt- und Luftbetrieb sind getrennt parametrierbar
   - Luftbegrenzung reduziert oder sperrt die betroffene Richtung
   - Zukunftsstrategien sind nicht versehentlich aktivierbar
...
10. Mindestpruefungen vor einem PR
    ...
    - alle in Issue #22 neu eingefuehrten Tests
...
11. Pull Request
    ...
    - `Closes #22` nur bei vollstaendig erfuellter Definition of Done; sonst `Refs #22`.
...
Reglerkern, Tests, Diagnosewerte und Dokumentation abgeschlossen; Parameter bleiben TBD_COMMISSIONING.
