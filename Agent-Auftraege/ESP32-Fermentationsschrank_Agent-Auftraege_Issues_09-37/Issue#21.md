# Agent-Auftrag fuer Issue #21

## Issue

**[E3.2] Regelsensorauswahl, Ersatzbetrieb und Rueckkehrlogik**  
Aktueller Snapshot-Status: `PLANNED_SPEC_PENDING`  
Epic: #5  
GitHub: https://github.com/ManuEngineer/ESP32-Fermentationsschrank/issues/21
...
```text
Arbeite im Repository `ManuEngineer/ESP32-Fermentationsschrank` ausschliesslich an Issue #21:
"[E3.2] Regelsensorauswahl, Ersatzbetrieb und Rueckkehrlogik"
...
2. Vor jeder Aenderung vollstaendig lesen
   - das aktuelle GitHub-Issue #21 inklusive Kommentare
   - `AGENTS.md`
...
5. Branch
   ...
   `feat/issue-21-regelsensorauswahl-ersatzbetrieb-und-rueckkehrlogik`

   Keine Aenderungen direkt auf `main`. Keine anderen Issues in diesen Branch aufnehmen.

6. Verbindlicher Scope von Issue #21
   - produkt- und luftgefuehrter Betrieb
   - Produktfuehler primaer, Schrankluft als Begrenzung/Sicherheit
   - Peltier bei Produktfuehlerfehler zuerst aus
   - programmabhaengiger Wechsel auf Luft nach Wartezeit und Sicherheitspruefung
   - Rueckkehrstrategien: bis Laufende auf Luft, manuell, automatisch validiert
   - automatische validierte Rueckkehr als Standard fuer produktgefuehrte Programme
   - Sensorrolle beim Kuehlen und Halten beibehalten

7. Akzeptanzkriterien
   - kein stiller Sensorwechsel
   - gleichzeitiger Ausfall der festen Sicherheitssensoren verhindert Peltierfreigabe
   - Rueckkehr erfolgt erst nach mehreren plausiblen stabilen Messungen
   - jeder Wechsel wird als Laufereignis sichtbar

8. Issue-spezifische Tests und Nachweise
   - Produktfuehler aus/auf
   - unplausible Rueckkehr
   - gleichzeitige Fehler
   - alle Rueckkehrstrategien
...
10. Mindestpruefungen vor einem PR
    ...
    - alle in Issue #21 neu eingefuehrten Tests
...
11. Pull Request
    ...
    - `Closes #21` nur bei vollstaendig erfuellter Definition of Done; sonst `Refs #21`.
...
Auswahl- und Ersatzlogik, Tests und Dokumentation abgeschlossen.
