# Agent-Auftrag fuer Issue #13

## Issue

**[E1.2] Unveraenderlichen Laufschnappschuss und Laufrevisionen implementieren**  
Aktueller Snapshot-Status: `PLANNED_SPEC_PENDING`  
Epic: #3  
GitHub: https://github.com/ManuEngineer/ESP32-Fermentationsschrank/issues/13
...
```text
Arbeite im Repository `ManuEngineer/ESP32-Fermentationsschrank` ausschliesslich an Issue #13:
"[E1.2] Unveraenderlichen Laufschnappschuss und Laufrevisionen implementieren"
...
2. Vor jeder Aenderung vollstaendig lesen
   - das aktuelle GitHub-Issue #13 inklusive Kommentare
   - `AGENTS.md`
...
5. Branch
   ...
   `feat/issue-13-unveraenderlichen-laufschnappschuss-und-laufrevision`

   Keine Aenderungen direkt auf `main`. Keine anderen Issues in diesen Branch aufnehmen.

6. Verbindlicher Scope von Issue #13
   - unveraenderlicher Programmschnappschuss beim Start
   - getrennte effektive Laufwerte
   - protokollierte Laufrevisionen fuer Zieltemperatur und Restdauer
   - Herkunft, alte/neue Werte und Zeitbezug
   - keine rueckwirkende Aenderung abgeschlossener Phasen

7. Akzeptanzkriterien
   - Quellprogramm bleibt bei Laufanpassungen unveraendert
   - jede Aenderung ist nachvollziehbar und atomar
   - Wiederanlauf verwendet den gespeicherten Schnappschuss
   - ungueltige oder unsichere Aenderungen werden abgelehnt

8. Issue-spezifische Tests und Nachweise
   - Start mit Benutzer- und Standardprogramm
   - Zieltemperatur- und Daueranpassung
   - Neustart nach Laufrevision
   - abgelehnte Grenzwertverletzung
...
10. Mindestpruefungen vor einem PR
    ...
    - alle in Issue #13 neu eingefuehrten Tests
...
11. Pull Request
    ...
    - `Closes #13` nur bei vollstaendig erfuellter Definition of Done; sonst `Refs #13`.
...
Datenmodell, Revisionen, Validierung, Tests und Dokumentation abgeschlossen.
