# Agent-Auftrag fuer Issue #18

## Issue

**[E2.3] Wiederanlauf und temperaturgewichteten Fortschritt implementieren**  
Aktueller Snapshot-Status: `PLANNED_SPEC_PENDING`  
Epic: #4  
GitHub: https://github.com/ManuEngineer/ESP32-Fermentationsschrank/issues/18
...
```text
Arbeite im Repository `ManuEngineer/ESP32-Fermentationsschrank` ausschliesslich an Issue #18:
"[E2.3] Wiederanlauf und temperaturgewichteten Fortschritt implementieren"
...
2. Vor jeder Aenderung vollstaendig lesen
   - das aktuelle GitHub-Issue #18 inklusive Kommentare
   - `AGENTS.md`
...
5. Branch
   ...
   `feat/issue-18-wiederanlauf-und-temperaturgewichteten-fortschritt-i`

   Keine Aenderungen direkt auf `main`. Keine anderen Issues in diesen Branch aufnehmen.

6. Verbindlicher Scope von Issue #18
   - phasenbezogener Wiederanlauf nach Stromunterbrechung
   - Betrieb ohne sofort verfuegbare NTP-Zeit
   - spaetere Korrektur durch absolute Zeit
   - konservative temperaturgewichtete Fortschrittsbewertung
   - Produktfuehler bevorzugt, Luftfuehler als niedrigere Vertrauensstufe
   - sichtbare Schaetzung, Vertrauen und Korrektur

7. Akzeptanzkriterien
   - Wiederanlauf beginnt immer mit ausgeschalteten Aktoren und validiertem Zustand
   - fehlende NTP-Zeit allein beendet keinen Lauf
   - Zielqualifikation wird nach Unterbrechung korrekt neu bewertet
   - unsichere Situationen werden nicht geraten
   - Benutzer kann Korrektur nachvollziehen

8. Issue-spezifische Tests und Nachweise
   - kurze, mittlere und lange Unterbrechung in jeder wesentlichen Phase, mit und ohne NTP
...
10. Mindestpruefungen vor einem PR
    ...
    - alle in Issue #18 neu eingefuehrten Tests
...
11. Pull Request
    ...
    - `Closes #18` nur bei vollstaendig erfuellter Definition of Done; sonst `Refs #18`.
...
Wiederanlauflogik, Simulationsfaelle und Dokumentation abgeschlossen.
