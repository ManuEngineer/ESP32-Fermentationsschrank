# Agent-Auftrag fuer Issue #19

## Issue

**[E2.4] Journale, Aufbewahrung, Bereinigung, Backup und Import**  
Aktueller Snapshot-Status: `PLANNED_SPEC_PENDING`  
Epic: #4  
GitHub: https://github.com/ManuEngineer/ESP32-Fermentationsschrank/issues/19
...
```text
Arbeite im Repository `ManuEngineer/ESP32-Fermentationsschrank` ausschliesslich an Issue #19:
"[E2.4] Journale, Aufbewahrung, Bereinigung, Backup und Import"
...
2. Vor jeder Aenderung vollstaendig lesen
   - das aktuelle GitHub-Issue #19 inklusive Kommentare
   - `AGENTS.md`
...
5. Branch
   ...
   `feat/issue-19-journale-aufbewahrung-bereinigung-backup-und-import`

   Keine Aenderungen direkt auf `main`. Keine anderen Issues in diesen Branch aufnehmen.

6. Verbindlicher Scope von Issue #19
   - priorisiertes Fehler-, Reset- und Ereignisjournal
   - begrenzte Mess- und Laufhistorie
   - proaktive atomare Bereinigung nichtkritischer Daten
   - Standardaufbewahrung: aktiver Lauf, letzte 5 detailliert, 50 Zusammenfassungen
   - Laufexport JSON/CSV
   - normales Backup ohne Geheimnisse
   - validierter Import mit Schema, Vorschau und atomarer Aktivierung
   - Werksreset mit beibehaltener Touchkalibrierung

7. Akzeptanzkriterien
   - kritische Daten werden nie vor Komfortdaten geloescht
   - Speicher kann im Test bis zur Bereinigung gefuellt werden
   - Import veraendert aktive Daten erst nach vollstaendiger Validierung
   - Exporte enthalten keine Passwoerter, PINs oder Tokens
   - vergessene PIN fuehrt nur ueber lokalen Vollreset zur Wiederherstellung

8. Issue-spezifische Tests und Nachweise
   - volle Historie
   - Stromunterbrechung bei Bereinigung/Import
   - ungueltiges Schema
   - Geheimnispruefung
...
10. Mindestpruefungen vor einem PR
    ...
    - alle in Issue #19 neu eingefuehrten Tests
...
11. Pull Request
    ...
    - `Closes #19` nur bei vollstaendig erfuellter Definition of Done; sonst `Refs #19`.
...
Datenformate, Bereinigung, Tests und Dokumentation abgeschlossen.
