# Agent-Auftrag fuer Issue #12

## Issue

**[E1.1] Programmmodelle, Schema und Standardprogramme**  
Aktueller Snapshot-Status: `PLANNED_SPEC_PENDING`  
Epic: #3  
GitHub: https://github.com/ManuEngineer/ESP32-Fermentationsschrank/issues/12
...
```text
Arbeite im Repository `ManuEngineer/ESP32-Fermentationsschrank` ausschliesslich an Issue #12:
"[E1.1] Programmmodelle, Schema und Standardprogramme"
...
2. Vor jeder Aenderung vollstaendig lesen
   - das aktuelle GitHub-Issue #12 inklusive Kommentare
   - `AGENTS.md`
...
5. Branch
   ...
   `feat/issue-12-programmmodelle-schema-und-standardprogramme`

   Keine Aenderungen direkt auf `main`. Keine anderen Issues in diesen Branch aufnehmen.

6. Verbindlicher Scope von Issue #12
   - versionierte Programmmodelle und Validierung
   - vier Standardprogramme: Joghurt mild, Joghurt stichfest, Milchkefir, Wasserkefir
   - eine Fermentationstemperatur in Release 1; spaetere Stufen vorbereiten
   - Vorheizen, Sensorrolle, Zeitlimits und Abschlussmodus
   - exakte Inbetriebnahmewerte als `TBD_COMMISSIONING`
   - unveraenderlicher Factory-Katalog und kopierbare Benutzerprogramme

7. Akzeptanzkriterien
   - gueltige und ungueltige Programme werden deterministisch erkannt
   - Standardprogramme koennen nicht still veraendert werden
   - aktive Auswahl und Factory-Katalog bleiben getrennt
   - Schema ist versioniert und migrationsfaehig

8. Issue-spezifische Tests und Nachweise
   - Grenzwerte, Pflichtfelder, unbekannte Felder und Schemaversionen
   - Laden aller vier Standardprogramme
...
10. Mindestpruefungen vor einem PR
    ...
    - alle in Issue #12 neu eingefuehrten Tests
...
11. Pull Request
    ...
    - `Closes #12` nur bei vollstaendig erfuellter Definition of Done; sonst `Refs #12`.
...
Modelle, Validierung, Standarddaten, Tests und Dokumentation abgeschlossen.
